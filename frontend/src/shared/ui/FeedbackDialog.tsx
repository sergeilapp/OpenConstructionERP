...
const CATEGORIES: {
...
}[] = [
  {
    key: "bug",
    icon: Bug,
    labelKey: "feedback.category_bug",
    defaultLabel: "Bug Report",
  },
  {
    key: "idea",
    icon: Lightbulb,
    labelKey: "feedback.category_idea",
    defaultLabel: "Feature Idea",
  },
  {
    key: "general",
    icon: MessageCircle,
    labelKey: "feedback.category_general",
    ...
    try {
      ...
      addToast({
        ...
        title: t("feedback.success", {
          defaultValue: "Thank you! Your feedback has been received.‌⁠‍",
        }),
      });
      onClose();
    } catch {
      addToast({
        ...
        title: t("feedback.error", {
          defaultValue:
            "Could not send feedback. Please try again or report on GitHub.‌⁠‍",
        }),
      });
    } finally {
      setSending(false);
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="px-6 pb-6 space-y-4">
          ...
          <div>
            ...
            <p className="mt-1 text-2xs text-content-quaternary">
              {t("feedback.email_hint", {
                defaultValue: "For follow-up — we won't spam",
              })}
            </p>
          </div>
          ...
          <div className="flex items-center justify-between pt-1">
            ...
            >
              {t("feedback.github_link", {
                defaultValue: "Or report on GitHub",
              })}
