  ...
  try {
    switch (format) {
      case "relative":
        ...
        break;
      case "datetime":
        formatted = new Intl.DateTimeFormat(locale, DATETIME_OPTIONS).format(
          dateObj,
        );
        break;
      case "time":
        formatted = new Intl.DateTimeFormat(locale, TIME_OPTIONS).format(
          dateObj,
        );
        break;
      case "date":
      default:
        formatted = new Intl.DateTimeFormat(locale, DATE_OPTIONS).format(
          dateObj,
        );
        break;
    }
