    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-content-tertiary">
            {t("collab.subtitle", {
              defaultValue:
                "Work together on estimates in real-time with your team‌⁠‍",
            })}
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <FeatureCard
          ...
          title={t("collab.feature_sync", {
            defaultValue: "Peer-to-Peer Sync‌⁠‍",
          })}
          description={t("collab.feature_sync_desc", {
            defaultValue:
              "Changes sync directly between browsers via WebRTC. No server required — works with just a signaling server for connection setup.‌⁠‍",
          })}
        />
        <FeatureCard
          icon={<Zap className="h-5 w-5 text-amber-500" />}
          title={t("collab.feature_crdt", {
            defaultValue: "CRDT Conflict Resolution‌⁠‍",
          })}
          description={t("collab.feature_crdt_desc", {
            defaultValue:
              "Built on Yjs — a battle-tested CRDT library. Concurrent edits merge automatically without conflicts. No data loss.",
          })}
        />
        <FeatureCard
          icon={<Shield className="h-5 w-5 text-emerald-500" />}
          title={t("collab.feature_presence", {
            defaultValue: "Presence Awareness",
          })}
          description={t("collab.feature_presence_desc", {
            defaultValue:
              "See who is online, what they are editing, and where their cursor is. Colored indicators show active collaborators.",
          })}
        />
      </div>
        ...
        <div className="flex items-center gap-3 max-w-sm">
          <div className="flex-1">
            ...
            <input
              ...
              placeholder={t("collab.name_placeholder", {
                defaultValue: "Your name",
              })}
              aria-label={t("collab.display_name", {
          ...
          <button
            ...
            aria-label={t("collab.save_name", {
              defaultValue: "Save display name",
            })}
          >
      ...
      <div className="rounded-xl border border-border bg-surface-primary p-5">
        ...
        <p className="text-xs text-content-tertiary mb-3">
          {t("collab.color_desc", {
            defaultValue:
              "Colors are automatically assigned when you join a session. Each collaborator gets a unique color.",
          })}
        </p>
      ...
      <div className="rounded-xl border border-border bg-surface-primary p-5">
        ...
        <ol className="space-y-2 text-xs text-content-secondary">
          <li className="flex gap-2">
            <span className="flex h-5 w-5 items-center justify-center rounded-full bg-oe-blue text-white text-2xs font-bold shrink-0">
              1
            </span>
          ...
          <li className="flex gap-2">
            ...
            {t("collab.step2", {
              defaultValue:
                'Click "Share" in the collaboration bar above the grid',
            })}
          </li>
          <li className="flex gap-2">
            <span className="flex h-5 w-5 items-center justify-center rounded-full bg-oe-blue text-white text-2xs font-bold shrink-0">
            ...
            {t("collab.step3", {
              defaultValue: "Send the link to your teammates",
            })}
          </li>
          <li className="flex gap-2">
            <span className="flex h-5 w-5 items-center justify-center rounded-full bg-oe-blue text-white text-2xs font-bold shrink-0">
            ...
            {t("collab.step4", {
              defaultValue: "Edit together — changes appear in real-time",
            })}
          </li>
        </ol>
      </div>
