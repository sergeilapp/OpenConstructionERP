...
export function ConflictResolutionPanel({
  ...
  const activeConflict =
    conflicts[Math.min(currentIndex, conflicts.length - 1)];
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label={t("conflict.panel_aria_label", {
        defaultValue: "Conflict resolution panel‌⁠‍",
      })}
    >
      <div
        ref={panelRef}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-sm font-semibold text-content-primary">
                {t("conflict.panel_title", {
                  defaultValue: "Merge Conflict Detected‌⁠‍",
                })}
              </h2>
          ...
          <div className="grid grid-cols-2 gap-4 px-6 py-5">
            ...
            <ValueCard
              ...
              action={
                ...
                >
                  {t("conflict.accept_theirs", {
                    defaultValue: "Accept theirs",
                  })}
                </button>
              }
            />
        ...
        {activeConflict && (
          <div className="px-6 pb-5">
            {!manualMode ? (
              ...
              >
                <Edit3 size={12} />
                {t("conflict.manual_merge", {
                  defaultValue: "Manual merge...",
                })}
              </button>
            ) : (
              <div className="space-y-2">
                <label className="block text-xs font-medium text-content-secondary">
                  {t("conflict.manual_label", {
                    defaultValue: "Enter merged value",
                  })}
                </label>
                <textarea
                  ref={manualInputRef}
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    ...
                    {t("conflict.apply_merged", {
                      defaultValue: "Apply merged value",
                    })}
                  </button>
                  <button
                    onClick={() => {
...
function ValueCard({
  ...
  const borderColor =
    variant === "local" ? "border-oe-blue/40" : "border-border";
  const headerBg =
    variant === "local"
