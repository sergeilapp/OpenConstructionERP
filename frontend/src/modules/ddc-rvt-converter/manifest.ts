...
export const manifest: ModuleManifest = {
  ...
  translations: {
    en: {
      ...
      "converter.rvt.desc":
        "Convert Revit (.rvt) files to DataFrame + COLLADA geometry",
    },
    de: {
      "converter.rvt.name": "DDC cad2data — Revit Konverter",
      "converter.rvt.desc":
        "Revit-Dateien (.rvt) in DataFrame + COLLADA-Geometrie konvertieren",
    },
    ru: {
      "converter.rvt.name": "DDC cad2data — Revit Конвертер",
      "converter.rvt.desc":
        "Конвертация файлов Revit (.rvt) в DataFrame + COLLADA геометрию",
    },
  },
};
