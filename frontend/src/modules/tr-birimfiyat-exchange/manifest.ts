...
export const manifest: ModuleManifest = {
  ...
  description:
    "Import/export BOQs in Turkish Bayindirlik Birim Fiyat format (Excel/CSV)",
  version: "1.0.0",
  icon: Building2,
  category: "regional",
  ...
  translations: {
    ...
    tr: {
      ...
      "tr.drop_file":
        "Birim Fiyat dosyasini buraya surukleyin (Excel veya CSV), veya",
      "tr.browse": "Dosya sec",
      "tr.formats_hint":
        "Desteklenen: .csv, .tsv, .xlsx (Birim Fiyat formatli kesif)",
    ...
    ru: {
      ...
      "tr.subtitle":
        "Obmen dannymi smety v formate Bayindirlik Birim Fiyat (Excel / CSV)",
      "tr.tab_import": "Import",
