...
export default function TRExchangeModule() {
  ...
  const [exportFormat, setExportFormat] = useState<TRExportFormat>(
    "birimfiyat-detailed",
  );
  ...
  const handleImport = useCallback(async () => {
    ...
    try {
      ...
      await apiGet<{ imported: number }>(
        ...
        {
          method: "POST",
          body: JSON.stringify({ positions, source: "tr_birimfiyat_import" }),
        } as never,
      );
      ...
      addToast({
        ...
        title: t("tr.import_complete", {
          defaultValue: "Turkish Birim Fiyat import complete",
        }),
      ...
      addToast({
        type: "error",
        title: t("tr.import_failed", {
          defaultValue: "Turkish Birim Fiyat import failed",
        }),
  ...
  const handleExport = useCallback(() => {
    ...
    try {
      ...
      addToast({
        type: "success",
        title: t("tr.export_complete", {
          defaultValue: "Turkish Birim Fiyat export complete",
        }),
      ...
      addToast({
        type: "error",
        title: t("tr.export_failed", {
          defaultValue: "Turkish Birim Fiyat export failed",
        }),
        message: err instanceof Error ? err.message : "Unknown error",
      });
    } finally {
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-content-primary">
            {t("tr.title", {
              defaultValue: "Turkey Birim Fiyat Import / Export",
            })}
          </h1>
            ...
            {importFile ? (
                  ...
                  <div className="flex items-center justify-center gap-1.5 text-xs text-emerald-600">
                    ...
                    {parsedPositions.every((p) => p.unitRate === 0) && (
                      <Badge variant="neutral" className="ml-2">
                        {t("tr.summary", {
                          defaultValue: "Birim Fiyat Summary",
                        })}
                      </Badge>
                    )}
                  </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-content-secondary">
                  {t("tr.drop_file", {
                    defaultValue:
                      "Drop a Turkish Birim Fiyat BOQ file here (Excel or CSV), or",
                  })}
                </p>
                <Button
                  variant="secondary"
                ...
                <p className="text-2xs text-content-quaternary">
                  {t("tr.formats_hint", {
                    defaultValue:
                      "Supported: .csv, .tsv, .xlsx (Birim Fiyat-formatted BOQ)",
                  })}
                </p>
              </div>
            )}
          ...
          {parsedPositions && parsedPositions.length > 0 && (
            <div className="rounded-lg border border-border-light bg-surface-secondary/30 p-3">
              <div className="flex items-center gap-1.5 text-xs font-medium text-content-secondary mb-2">
                <Info size={13} />
                {t("tr.trades_ref", {
                  defaultValue: "Birim Fiyat Trade Sections Reference",
                })}
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <select
                  value={exportFormat}
                  onChange={(e) =>
                    setExportFormat(e.target.value as TRExportFormat)
                  }
                  className="w-full rounded-lg border border-border bg-surface-secondary px-3 py-2 text-sm"
                >
            ...
            <div className="rounded-xl border border-border bg-surface-primary p-5 space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                ...
                <div className="rounded-lg bg-surface-secondary/50 p-3 text-center">
                  ...
                  <div className="text-lg font-bold text-content-primary">
                    {exportFormat === "birimfiyat-detailed"
                      ? "Detailed"
                      : "Summary"}
                  </div>
                </div>
