...
export const manifest: ModuleManifest = {
  ...
  translations: {
    ...
    cs: {
      ...
      "cz.drop_file":
        "Pretahnete sem cesky soubor rozpoctu (Excel nebo CSV), nebo",
      "cz.browse": "Vybrat soubory",
      "cz.formats_hint":
        "Podporovane: .csv, .tsv, .xlsx (rozpocet ve formatu URS/TSKP)",
    ...
    ru: {
      ...
      "cz.subtitle":
        "Obmen dannymi smety v cheshskom formate URS / TSKP (Excel / CSV)",
      "cz.tab_import": "Import",
