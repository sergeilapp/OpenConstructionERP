...
export default function ESExchangeModule() {
  ...
  const [exportFormat, setExportFormat] =
    useState<ESExportFormat>("pbc-detailed");
  ...
  const handleImport = useCallback(async () => {
    ...
    try {
      ...
      await apiGet<{ imported: number }>(
        ...
        {
          method: "POST",
          body: JSON.stringify({ positions, source: "es_pbc_import" }),
        } as never,
      );
      ...
      addToast({
        ...
        title: t("es.import_complete", {
          defaultValue: "Spanish PBC import complete",
        }),
  ...
  const handleExport = useCallback(() => {
    ...
    try {
      ...
      addToast({
        type: "success",
        title: t("es.export_complete", {
          defaultValue: "Spanish PBC export complete",
        }),
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-content-primary">
            {t("es.title", {
              defaultValue: "Spain PBC / Base de Precios Import / Export",
            })}
          </h1>
            ...
            {importFile ? (
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-content-secondary">
                  {t("es.drop_file", {
                    defaultValue:
                      "Drop a Spanish PBC file here (Excel or CSV), or",
                  })}
                </p>
                <Button
                  variant="secondary"
                ...
                <p className="text-2xs text-content-quaternary">
                  {t("es.formats_hint", {
                    defaultValue:
                      "Supported: .csv, .tsv, .xlsx (PBC-formatted BOQ)",
                  })}
                </p>
              </div>
            )}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <select
                  value={exportFormat}
                  onChange={(e) =>
                    setExportFormat(e.target.value as ESExportFormat)
                  }
                  className="w-full rounded-lg border border-border bg-surface-secondary px-3 py-2 text-sm"
                >
