...
export default function NLExchangeModule() {
  ...
  const [exportFormat, setExportFormat] =
    useState<NLExportFormat>("stabu-detailed");
  ...
  const handleImport = useCallback(async () => {
    ...
    try {
      ...
      await apiGet<{ imported: number }>(
        ...
        {
          method: "POST",
          body: JSON.stringify({ positions, source: "nl_stabu_import" }),
        } as never,
      );
      ...
      addToast({
        ...
        title: t("nl.import_complete", {
          defaultValue: "Dutch STABU BOQ import complete",
        }),
      ...
      addToast({
        type: "error",
        title: t("nl.import_failed", {
          defaultValue: "Dutch STABU import failed",
        }),
  ...
  const handleExport = useCallback(() => {
    ...
    try {
      ...
      addToast({
        type: "success",
        title: t("nl.export_complete", {
          defaultValue: "Dutch STABU BOQ export complete",
        }),
      ...
      addToast({
        type: "error",
        title: t("nl.export_failed", {
          defaultValue: "Dutch STABU export failed",
        }),
        message: err instanceof Error ? err.message : "Unknown error",
      });
    } finally {
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-content-primary">
            {t("nl.title", {
              defaultValue: "Netherlands STABU Import / Export",
            })}
          </h1>
          <p className="text-sm text-content-tertiary">
            {t("nl.subtitle", {
              defaultValue:
                "Exchange Bills of Quantities in STABU / RAW format (Excel / CSV)",
            })}
          </p>
        </div>
      </div>
            ...
            {importFile ? (
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-content-secondary">
                  {t("nl.drop_file", {
                    defaultValue:
                      "Drop a Dutch STABU/RAW BOQ file here (Excel or CSV), or",
                  })}
                </p>
                <Button
                  variant="secondary"
                ...
                <p className="text-2xs text-content-quaternary">
                  {t("nl.formats_hint", {
                    defaultValue:
                      "Supported: .csv, .tsv, .xlsx (STABU/RAW-formatted BOQ)",
                  })}
                </p>
              </div>
            )}
          ...
          {parsedPositions && parsedPositions.length > 0 && (
            <div className="rounded-lg border border-border-light bg-surface-secondary/30 p-3">
              <div className="flex items-center gap-1.5 text-xs font-medium text-content-secondary mb-2">
                <Info size={13} />
                {t("nl.trades_ref", {
                  defaultValue: "STABU Chapter Reference",
                })}
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <select
                  value={exportFormat}
                  onChange={(e) =>
                    setExportFormat(e.target.value as NLExportFormat)
                  }
                  className="w-full rounded-lg border border-border bg-surface-secondary px-3 py-2 text-sm"
                >
