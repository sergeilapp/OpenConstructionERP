...
export const manifest: ModuleManifest = {
  ...
  description:
    "Import/export BOQs in DIN 276 / ÖNORM B 1801 / SIA 112 format (Excel/CSV)",
  version: "1.0.0",
  icon: Landmark,
  category: "regional",
  ...
  translations: {
    ...
    de: {
      ...
      "din.title": "DACH DIN 276 Import / Export",
      "din.subtitle":
        "Leistungsverzeichnis im DIN 276 / ÖNORM / SIA-Format austauschen (Excel / CSV)",
      ...
      "din.info":
        "DIN 276 (Kosten im Bauwesen) ist der primäre Kostenklassifikationsstandard für Deutschland, Österreich (ÖNORM B 1801) und die Schweiz (SIA 112). Kompatibel mit GAEB, BKI und Standard-DACH-Kalkulationsworkflows.",
      "din.drop_file": "DIN 276 LV-Datei hierher ziehen (Excel oder CSV), oder",
      "din.browse": "Dateien durchsuchen",
      "din.formats_hint":
        "Unterstützt: .csv, .tsv, .xlsx (DIN 276 / ÖNORM / SIA-formatiertes LV)",
      "din.classification": "DIN 276 KG",
      "din.export_format": "Format",
    ...
    ru: {
      ...
      "din.title": "DACH DIN 276 Import / Export",
      "din.subtitle":
        "Obmen dannymi smety v formate DIN 276 / ÖNORM / SIA (Excel / CSV)",
      "din.tab_import": "Import",
