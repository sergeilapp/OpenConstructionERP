...
export const manifest: ModuleManifest = {
  ...
  description:
    "Import/export BOQs in Canadian MasterFormat/CIQS format (Excel/CSV)",
  version: "1.0.0",
  icon: MapPin,
  category: "regional",
  ...
  translations: {
    en: {
      ...
      "ca.formats_hint":
        "Supported: .csv, .tsv, .xlsx (MasterFormat/CIQS-formatted BOQ)",
    ...
    fr: {
      ...
      "ca.subtitle":
        "Echange de bordereaux de quantites au format canadien MasterFormat / CIQS (Excel / CSV)",
      ...
      "ca.info":
        "La construction canadienne utilise le CSI MasterFormat (adapte pour le Canada par CSC) et les normes CIQS (Institut canadien des metreurs). Compatible avec MERX, Altus Group et les systemes d'appel d'offres provinciaux.",
      "ca.drop_file":
        "Deposez un fichier de bordereau canadien ici (Excel ou CSV), ou",
      "ca.browse": "Parcourir les fichiers",
      "ca.formats_hint":
        "Formats acceptes : .csv, .tsv, .xlsx (bordereau format MasterFormat/CIQS)",
    ...
    de: {
      ...
      "ca.subtitle":
        "Leistungsverzeichnis im kanadischen MasterFormat/CIQS-Format austauschen (Excel / CSV)",
    ...
    ru: {
      ...
      "ca.subtitle":
        "Obmen dannymi smety v kanadskom formate MasterFormat / CIQS (Excel / CSV)",
      "ca.tab_import": "Import",
