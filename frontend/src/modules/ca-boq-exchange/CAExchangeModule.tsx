          ...
          <thead>
            <tr className="bg-surface-secondary/50 sticky top-0">
              ...
              <th className="px-3 py-1.5 text-left font-medium text-content-secondary w-32">
                {t("ca.classification", {
                  defaultValue: "MasterFormat/CIQS Code",
                })}
              </th>
            </tr>
          </thead>
...
export default function CAExchangeModule() {
  ...
  const [exportFormat, setExportFormat] = useState<CAExportFormat>(
  ...
  const handleImport = useCallback(async () => {
    ...
    try {
      ...
      await apiGet<{ imported: number }>(
        ...
        {
          method: "POST",
          body: JSON.stringify({ positions, source: "ca_import" }),
        } as never,
      );
      ...
      addToast({
        ...
        title: t("ca.import_complete", {
          defaultValue: "Canadian BOQ import complete",
        }),
      ...
      addToast({
        type: "error",
        title: t("ca.import_failed", {
          defaultValue: "Canadian import failed",
        }),
  ...
  const handleExport = useCallback(() => {
    ...
    try {
      ...
      addToast({
        type: "success",
        title: t("ca.export_complete", {
          defaultValue: "Canadian BOQ export complete",
        }),
      ...
      addToast({
        type: "error",
        title: t("ca.export_failed", {
          defaultValue: "Canadian export failed",
        }),
        message: err instanceof Error ? err.message : "Unknown error",
      });
    } finally {
            ...
            {importFile ? (
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-content-secondary">
                  {t("ca.drop_file", {
                    defaultValue:
                      "Drop a Canadian BOQ file here (Excel or CSV), or",
                  })}
                </p>
                <Button
                  variant="secondary"
          ...
          {parsedPositions && parsedPositions.length > 0 && (
            <div className="rounded-lg border border-border-light bg-surface-secondary/30 p-3">
              <div className="flex items-center gap-1.5 text-xs font-medium text-content-secondary mb-2">
                ...
                {t("ca.sections_ref", {
                  defaultValue:
                    "Canadian MasterFormat Trade Sections Reference",
                })}
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <select
                  value={exportFormat}
                  onChange={(e) =>
                    setExportFormat(e.target.value as CAExportFormat)
                  }
                  className="w-full rounded-lg border border-border bg-surface-secondary px-3 py-2 text-sm"
                >
