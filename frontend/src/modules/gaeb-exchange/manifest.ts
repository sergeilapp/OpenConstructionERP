...
export const manifest: ModuleManifest = {
  ...
  description:
    "Exchange BOQ data in GAEB DA XML 3.3 format — import X81/X83 files and export tender/bid documents",
  version: "1.0.0",
  icon: FileText,
  category: "regional",
  defaultEnabled: true,
  ...
  translations: {
    ...
    de: {
      ...
      "gaeb.subtitle":
        "Leistungsverzeichnis im GAEB DA XML-Format austauschen (X81 / X83)",
    ...
    fr: {
      ...
      "gaeb.title": "GAEB DA XML 3.3 Import / Export",
      "gaeb.subtitle":
        "Échanger les données de DQE au format GAEB DA XML (X81 / X83)",
