...
export const manifest: ModuleManifest = {
  ...
  translations: {
    ...
    it: {
      ...
      "it_cm.drop_file":
        "Trascina qui un file Computo Metrico (Excel o CSV), oppure",
    ...
    de: {
      ...
      "it_cm.import_complete":
        "Italienisches Computo Metrico-Import abgeschlossen",
      "it_cm.export_complete":
        "Italienisches Computo Metrico-Export abgeschlossen",
    },
    ru: {
