    ...
    <div className="border border-border-light rounded-lg overflow-hidden">
      <div className="px-3 py-2 bg-surface-tertiary/50 flex items-center justify-between">
        <span className="text-xs font-medium text-content-secondary">
          {t("it_cm.preview", { defaultValue: "Preview‌⁠‍" })}:{" "}
          {positions.length}{" "}
...
export default function ITExchangeModule() {
  ...
  const [exportFormat, setExportFormat] =
    useState<ITExportFormat>("computo-detailed");
      ...
      try {
        ...
        setParseError(
          t("it_cm.parse_error_generic", {
            defaultValue:
              "Failed to parse the Italian Computo Metrico BOQ file.",
          }),
        );
      }
    },
  ...
  const handleImport = useCallback(async () => {
    ...
    try {
      ...
      await apiGet<{ imported: number }>(
        ...
        {
          method: "POST",
          body: JSON.stringify({ positions, source: "it_computo_import" }),
        } as never,
      );
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-content-primary">
            {t("it_cm.title", {
              defaultValue: "Italy Computo Metrico Import / Export",
            })}
          </h1>
            ...
            {importFile ? (
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-content-secondary">
                  {t("it_cm.drop_file", {
                    defaultValue:
                      "Drop an Italian Computo Metrico file here (Excel or CSV), or",
                  })}
                </p>
                <Button
                  variant="secondary"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <select
                  value={exportFormat}
                  onChange={(e) =>
                    setExportFormat(e.target.value as ITExportFormat)
                  }
                  className="w-full rounded-lg border border-border bg-surface-secondary px-3 py-2 text-sm"
                >
