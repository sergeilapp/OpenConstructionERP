...
export default function BRExchangeModule() {
  ...
  const [exportFormat, setExportFormat] =
    useState<BRExportFormat>("sinapi-detailed");
  ...
  const handleImport = useCallback(async () => {
    ...
    try {
      ...
      await apiGet<{ imported: number }>(
        ...
        {
          method: "POST",
          body: JSON.stringify({ positions, source: "br_sinapi_import" }),
        } as never,
      );
      ...
      addToast({
        ...
        title: t("br.import_complete", {
          defaultValue: "Brazilian SINAPI import complete",
        }),
  ...
  const handleExport = useCallback(() => {
    ...
    try {
      ...
      addToast({
        type: "success",
        title: t("br.export_complete", {
          defaultValue: "Brazilian SINAPI export complete",
        }),
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-content-primary">
            {t("br.title", {
              defaultValue: "Brazil SINAPI / TCPO Import / Export",
            })}
          </h1>
          <p className="text-sm text-content-tertiary">
            {t("br.subtitle", {
              defaultValue:
                "Exchange Bills of Quantities in SINAPI / TCPO format (Excel / CSV)",
            })}
          </p>
        </div>
      </div>
            ...
            {importFile ? (
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-content-secondary">
                  {t("br.drop_file", {
                    defaultValue:
                      "Drop a SINAPI/TCPO BOQ file here (Excel or CSV), or",
                  })}
                </p>
                <Button
                  variant="secondary"
                ...
                <p className="text-2xs text-content-quaternary">
                  {t("br.formats_hint", {
                    defaultValue:
                      "Supported: .csv, .tsv, .xlsx (SINAPI/TCPO-formatted BOQ)",
                  })}
                </p>
              </div>
            )}
          ...
          {parsedPositions && parsedPositions.length > 0 && (
            <div className="rounded-lg border border-border-light bg-surface-secondary/30 p-3">
              <div className="flex items-center gap-1.5 text-xs font-medium text-content-secondary mb-2">
                <Info size={13} />
                {t("br.trades_ref", {
                  defaultValue: "SINAPI Trade Sections Reference",
                })}
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <select
                  value={exportFormat}
                  onChange={(e) =>
                    setExportFormat(e.target.value as BRExportFormat)
                  }
                  className="w-full rounded-lg border border-border bg-surface-secondary px-3 py-2 text-sm"
                >
