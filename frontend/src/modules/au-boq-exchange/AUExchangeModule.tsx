...
export default function AUExchangeModule() {
  ...
  const [exportFormat, setExportFormat] =
    useState<AUExportFormat>("acmm-detailed");
  ...
  const handleImport = useCallback(async () => {
    ...
    try {
      ...
      await apiGet<{ imported: number }>(
        ...
        {
          method: "POST",
          body: JSON.stringify({ positions, source: "au_acmm_import" }),
        } as never,
      );
      ...
      addToast({
        ...
        title: t("au.import_complete", {
          defaultValue: "Australian BOQ import complete",
        }),
      ...
      addToast({
        type: "error",
        title: t("au.import_failed", {
          defaultValue: "Australian import failed",
        }),
  ...
  const handleExport = useCallback(() => {
    ...
    try {
      ...
      addToast({
        type: "success",
        title: t("au.export_complete", {
          defaultValue: "Australian BOQ export complete",
        }),
      ...
      addToast({
        type: "error",
        title: t("au.export_failed", {
          defaultValue: "Australian export failed",
        }),
        message: err instanceof Error ? err.message : "Unknown error",
      });
    } finally {
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-content-tertiary">
            {t("au.subtitle", {
              defaultValue:
                "Exchange Bills of Quantities in ACMM/ANZSMM format (Excel / CSV)",
            })}
          </p>
        </div>
      </div>
            ...
            {importFile ? (
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-content-secondary">
                  {t("au.drop_file", {
                    defaultValue:
                      "Drop an Australian BOQ file here (Excel or CSV), or",
                  })}
                </p>
                <Button
                  variant="secondary"
                ...
                <p className="text-2xs text-content-quaternary">
                  {t("au.formats_hint", {
                    defaultValue:
                      "Supported: .csv, .tsv, .xlsx (ACMM/ANZSMM-formatted BOQ)",
                  })}
                </p>
              </div>
            )}
          ...
          {parsedPositions && parsedPositions.length > 0 && (
            <div className="rounded-lg border border-border-light bg-surface-secondary/30 p-3">
              <div className="flex items-center gap-1.5 text-xs font-medium text-content-secondary mb-2">
                <Info size={13} />
                {t("au.trades_ref", {
                  defaultValue: "ACMM Trade Sections Reference",
                })}
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <select
                  value={exportFormat}
                  onChange={(e) =>
                    setExportFormat(e.target.value as AUExportFormat)
                  }
                  className="w-full rounded-lg border border-border bg-surface-secondary px-3 py-2 text-sm"
                >
