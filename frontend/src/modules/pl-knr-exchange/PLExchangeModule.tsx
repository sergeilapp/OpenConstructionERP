...
export default function PLExchangeModule() {
  ...
  const [exportFormat, setExportFormat] =
    useState<PLExportFormat>("knr-detailed");
  ...
  const handleImport = useCallback(async () => {
    ...
    try {
      ...
      await apiGet<{ imported: number }>(
        ...
        {
          method: "POST",
          body: JSON.stringify({ positions, source: "pl_knr_import" }),
        } as never,
      );
      ...
      addToast({
        ...
        title: t("pl.import_complete", {
          defaultValue: "Polish KNR BOQ import complete",
        }),
      ...
      addToast({
        type: "error",
        title: t("pl.import_failed", {
          defaultValue: "Polish KNR import failed",
        }),
  ...
  const handleExport = useCallback(() => {
    ...
    try {
      ...
      addToast({
        type: "success",
        title: t("pl.export_complete", {
          defaultValue: "Polish KNR BOQ export complete",
        }),
      ...
      addToast({
        type: "error",
        title: t("pl.export_failed", {
          defaultValue: "Polish KNR export failed",
        }),
        message: err instanceof Error ? err.message : "Unknown error",
      });
    } finally {
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-content-tertiary">
            {t("pl.subtitle", {
              defaultValue:
                "Exchange Bills of Quantities in KNR / KNNR format (Excel / CSV)",
            })}
          </p>
        </div>
      </div>
            ...
            {importFile ? (
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-content-secondary">
                  {t("pl.drop_file", {
                    defaultValue:
                      "Drop a Polish KNR/KNNR BOQ file here (Excel or CSV), or",
                  })}
                </p>
                <Button
                  variant="secondary"
                ...
                <p className="text-2xs text-content-quaternary">
                  {t("pl.formats_hint", {
                    defaultValue:
                      "Supported: .csv, .tsv, .xlsx (KNR/KNNR-formatted BOQ)",
                  })}
                </p>
              </div>
            )}
          ...
          {parsedPositions && parsedPositions.length > 0 && (
            <div className="rounded-lg border border-border-light bg-surface-secondary/30 p-3">
              <div className="flex items-center gap-1.5 text-xs font-medium text-content-secondary mb-2">
                <Info size={13} />
                {t("pl.trades_ref", {
                  defaultValue: "KNR Trade Sections Reference",
                })}
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <select
                  value={exportFormat}
                  onChange={(e) =>
                    setExportFormat(e.target.value as PLExportFormat)
                  }
                  className="w-full rounded-lg border border-border bg-surface-secondary px-3 py-2 text-sm"
                >
