...
const DIN_276_TREE: ClassificationNode[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        code: "230",
        label: "Nichtöffentliche Erschließung / Private development",
      },
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          {
            code: "331",
            label: "Tragende Außenwände / Load-bearing ext. walls",
          },
          { code: "332", label: "Nichttragende Außenwände / Non-load-bearing" },
          { code: "333", label: "Außenstützen / External columns" },
          {
            code: "334",
            label: "Außentüren u. -fenster / Ext. doors & windows",
          },
          {
            code: "335",
            label: "Außenwandbekleidungen, außen / Ext. cladding",
          },
  ...
  },
  {
    ...
    children: [
      ...
      {
        code: "530",
        label: "Baukonstruktionen Außenanlagen / Ext. structures",
      },
...
function flattenTree(
  ...
  parentPath = "",
): Array<{ code: string; label: string; path: string }> {
  ...
  return (
    <>
      ...
      >
        ...
        <span className="shrink-0 font-mono text-2xs text-content-tertiary w-8">
          {node.code}
        </span>
...
export function ClassificationPicker({
  ...
  const selectedLabel = value
    ? flatItems.find((i) => i.code === value)?.label
    : null;
  ...
  const panel = (
    <div
      className={clsx(
        ...
        mode === "dropdown"
          ? "absolute left-0 top-full mt-1 z-50 w-72 max-h-80"
          : "w-full h-full",
      )}
    >
      {/* Header */}
      <div className="flex items-center gap-2 border-b border-border-light p-2">
        ...
        <span className="text-2xs font-medium text-content-tertiary uppercase">
