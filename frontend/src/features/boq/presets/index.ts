...
const UNIVERSAL_PRESETS: ColumnPreset[] = [
  {
    ...
    name: "Procurement",
    description:
      "Supplier, lead time, PO number, status — for purchasing tracking",
    icon: Package,
    ...
    columns: [
      {
        ...
        display_name: "CO₂ kg/unit",
        column_type: "number",
      },
      {
        name: "epd_reference",
        display_name: "EPD Reference",
        column_type: "text",
      },
      {
  ...
  },
  {
    ...
    name: "Status & Scope",
    description:
      "Position status, scope flag, risk level and owner — for review workflows",
    icon: Flag,
  ...
  },
  {
    ...
    name: "Tendering",
    description:
      "Bidder, bid amount and award status — track tender packages per position",
    icon: Gavel,
    iconClass: "text-indigo-600 bg-indigo-500/10",
    columns: [
      {
        name: "tender_package",
        display_name: "Tender Package",
        column_type: "text",
      },
  ...
  },
  {
    ...
    name: "Schedule",
    description:
      "Start, end, duration and WBS code — link BOQ rows to the construction schedule",
    icon: CalendarIcon,
...
const REGIONAL_PRESETS: ColumnPreset[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      {
        name: "daily_output",
        display_name: "Daily Output",
        column_type: "number",
      },
      {
        name: "rsmeans_code",
        display_name: "RSMeans Code",
        column_type: "text",
      },
    ],
  },
  {
    ...
    columns: [
      ...
      {
        name: "trade_element",
        display_name: "Trade Element",
        column_type: "text",
      },
      {
        name: "as_reference",
        display_name: "Australian Standard",
        column_type: "text",
      },
