...
export function BatchActionBar({
  ...
  const [factorDialog, setFactorDialog] = useState<FactorDialogState | null>(
    null,
  );
  const [classDialog, setClassDialog] =
    useState<ClassificationDialogState | null>(null);
  ...
  return (
    <>
      ...
      <div
        ...
        role="toolbar"
        aria-label={t("boq.batch_actions", {
        ...
        <div className="flex items-center gap-3 rounded-2xl border border-border-light bg-surface-elevated shadow-xl px-5 py-3">
          ...
          <div ref={unitDropdownRef} className="relative">
            <button
              ...
              aria-label={t("boq.batch_change_unit", {
                defaultValue: "Change unit‌⁠‍",
              })}
            ...
            {unitDropdownOpen && (
              <div
                role="listbox"
                aria-label={t("boq.unit_options", {
                  defaultValue: "Unit options",
                })}
                className="absolute bottom-full mb-2 left-0 w-36 rounded-xl border border-border-light bg-surface-elevated shadow-lg overflow-hidden animate-fade-in"
              >
          ...
          {onBatchFactor && (
            <button
              ...
              aria-label={t("boq.batch_rate_factor", {
                defaultValue: "Multiply rate by factor‌⁠‍",
              })}
          ...
          {onBatchFactor && (
            <button
              type="button"
              onClick={() =>
                setFactorDialog({ kind: "quantity", value: "1.00" })
              }
              aria-label={t("boq.batch_qty_factor", {
                defaultValue: "Multiply quantity by factor‌⁠‍",
              })}
          ...
          {onBatchSetClassification && (
            <button
              ...
              aria-label={t("boq.batch_set_classification", {
                defaultValue: "Set classification‌⁠‍",
              })}
            ...
            >
              <Tag size={14} />
              {t("boq.batch_set_classification", {
          ...
          <button
            ...
            aria-label={t("boq.batch_clear_selection", {
      ...
      {confirmDeleteOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div
            role="alertdialog"
            aria-modal="true"
            aria-label={t("boq.batch_delete_confirm_title", {
              defaultValue: "Delete positions",
            })}
            tabIndex={-1}
          ...
          >
            <div className="px-6 pt-6 pb-4">
              ...
              <h2 className="text-base font-semibold text-content-primary text-center">
                {t("boq.batch_delete_confirm_title", {
                  defaultValue: "Delete positions",
                })}
              </h2>
          ...
          <div
            ...
            aria-label={
              factorDialog.kind === "rate"
                ? t("boq.batch_rate_factor_title", {
                    defaultValue: "Multiply rate by factor‌⁠‍",
                  })
                : t("boq.batch_qty_factor_title", {
                    defaultValue: "Multiply quantity by factor‌⁠‍",
                  })
            }
            className="relative z-10 w-full max-w-sm mx-4 rounded-2xl border border-border-light bg-surface-elevated shadow-xl animate-scale-in focus:outline-none"
            ...
            <div className="px-6 pt-6 pb-4">
              ...
              <p className="mt-1 text-xs text-content-secondary">
                {t("boq.batch_factor_hint", {
                  defaultValue:
                    "Applied to {{count}} selected positions. Example: 1.10 = +10%.",
                  count,
                })}
              </p>
              <label className="mt-4 block">
                <span className="text-xs font-medium text-content-secondary">
                  {t("boq.batch_factor_label", {
                    defaultValue: "Factor (> 0)‌⁠‍",
                  })}
                </span>
                <input
                  autoFocus
                  ...
                  aria-label={t("boq.batch_factor_label", {
                    defaultValue: "Factor (> 0)‌⁠‍",
                  })}
                />
              </label>
            ...
            <div className="px-6 pt-6 pb-4">
              ...
              <label className="mt-3 block">
                ...
                <input
                  ...
                  className="mt-1 w-full h-9 rounded-md border border-border bg-surface-primary px-3 text-sm font-mono text-content-primary focus:outline-none focus:ring-2 focus:ring-oe-blue/30"
                  aria-label={t("boq.batch_class_code", {
                    defaultValue: "Code‌⁠‍",
                  })}
                />
              </label>
