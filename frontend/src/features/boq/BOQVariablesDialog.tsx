...
export function BOQVariablesDialog({
  open,
  onClose,
  boqId,
}: BOQVariablesDialogProps) {
  ...
  const replaceMutation = useMutation({
    mutationFn: (vars: BOQVariable[]) =>
      boqApi.replaceBoqVariables(boqId, vars),
    onSuccess: (saved) => {
                  ...
                  <tbody className="divide-y divide-border-light">
                    {drafts.map((d, i) => {
                      ...
                      return (
                        <tr
                          key={d.uid}
                          className={err ? "bg-semantic-error-bg/30" : ""}
                        >
                          <td className="px-3 py-2">
                            <div className="flex items-center gap-1">
                              <span className="text-content-tertiary text-xs select-none">
                                $
                              </span>
                              <input
                                type="text"
                          ...
                          <td className="px-3 py-2">
                            <select
                              ...
                              onChange={(e) =>
                                patchRow(d.uid, {
                                  type: e.target.value as BOQVariable["type"],
                                })
                              }
                          ...
                          <td className="px-3 py-2">
                            <input
                              ...
                              value={d.value}
                              onChange={(e) =>
                                patchRow(d.uid, { value: e.target.value })
                              }
                          ...
                          <td className="px-3 py-2">
                            <input
                              ...
                              value={d.description}
                              onChange={(e) =>
                                patchRow(d.uid, { description: e.target.value })
                              }
                              placeholder={t(
                                "boq.variables_description_placeholder",
                                {
