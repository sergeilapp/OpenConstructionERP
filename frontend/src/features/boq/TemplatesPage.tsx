...
const FALLBACK_TEMPLATES: BOQTemplate[] = [
  {
    ...
    description:
      "Multi-story residential with standard finishes, MEP, and exterior works",
    ...
    template_positions: [
      {
        ordinal: "01",
        description: "Earthworks & Foundations",
        unit: "",
        rate_per_m2: 0,
        section: "01",
      },
      ...
      {
        ordinal: "03.01",
        description: "External masonry walls",
        unit: "m2",
        rate_per_m2: 65,
        section: "03",
      },
      {
        ordinal: "03.02",
        description: "Thermal insulation ETICS",
        unit: "m2",
        rate_per_m2: 42,
        section: "03",
      },
      {
        ordinal: "03.03",
        description: "Windows triple-glazed",
        unit: "pcs",
        rate_per_m2: 55,
        section: "03",
      },
      ...
      {
        ordinal: "04.01",
        description: "Flat roof waterproofing",
        unit: "m2",
        rate_per_m2: 38,
        section: "04",
      },
      ...
      {
        ordinal: "05.01",
        description: "Interior partitions drywall",
        unit: "m2",
        rate_per_m2: 35,
        section: "05",
      },
      ...
      {
        ordinal: "06.01",
        description: "Heating system incl. radiators",
        unit: "lsum",
        rate_per_m2: 65,
        section: "06",
      },
      ...
      {
        ordinal: "09.01",
        description: "Landscaping & paving",
        unit: "m2",
        rate_per_m2: 28,
        section: "09",
      },
      {
        ordinal: "09.02",
        description: "Site utilities connections",
        unit: "lsum",
        rate_per_m2: 32,
        section: "09",
      },
  ...
  },
  {
    ...
    description:
      "Modern office with open floor plans, raised floors, and advanced MEP",
  ...
  },
  {
    ...
    description:
      "Steel-frame industrial building with concrete slab and basic services",
  ...
  },
  {
    ...
    description:
      "Educational facility with classrooms, assembly hall, and sports areas",
  ...
  },
  {
    ...
    description:
      "Healthcare facility with specialized MEP, clean rooms, and medical gas",
  ...
  },
  {
    ...
    description:
      "Multi-story hotel with standard rooms, lobby, restaurant, and spa",
    building_type: "hotel",
    icon: "hotel",
    sections: 7,
    positions: 20,
  ...
  },
  {
    ...
    description:
      "Retail space with shopfronts, HVAC, and tenant fit-out allowances",
  ...
  },
  {
    ...
    name: "Infrastructure",
    description:
      "Civil works including roads, bridges, utilities, and drainage",
...
export function TemplatesPage() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: (boq) => {
      ...
      addToast({
        type: "success",
        title: t("boq.template_created", {
          defaultValue: "BOQ created from template‌⁠‍",
        }),
      });
      navigate(`/boq/${boq.id}`);
    },
    onError: (e: Error) => {
      addToast({
        type: "error",
        title: t("boq.template_error", {
          defaultValue: "Failed to create BOQ from template‌⁠‍",
        }),
        message: e.message,
      });
    },
            ...
            <div className="px-6 py-6 space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  value={area}
                  onChange={(e) =>
                    handleAreaChange(Math.max(1, Number(e.target.value) || 1))
                  }
              ...
              >
                {createMutation.isPending
                  ...
                  : t("boq.create_from_template", {
                      defaultValue: "Create BOQ from Template",
                    })}
              </Button>
            </div>
          </div>
