    ...
    <div className="relative grid h-screen grid-cols-1 lg:grid-cols-2 bg-surface-secondary overflow-hidden">
      ...
      <div className="hidden lg:flex relative z-10 lg:order-2 flex-col justify-center pl-14 xl:pl-20 pr-12 xl:pr-16 py-6 overflow-hidden">
        ...
        {/* Value props — restored as a clean two-up grid with refined
            ...
            after the honeycomb. */}
        <div
          className="mt-2 grid grid-cols-2 gap-x-3 gap-y-1 animate-stagger-in"
          style={{ animationDelay: "320ms" }}
        >
          {[
            {
              icon: ShieldCheck,
              title: t("login.feat_local_title", {
                defaultValue: "Your data, your machine",
              }),
              desc: t("login.feat_local", {
                defaultValue:
                  "Nothing leaves your computer. Full ownership,\nzero cloud dependency.",
              }),
            },
            {
              icon: Brain,
              title: t("login.feat_ai_title", {
                defaultValue: "AI-assisted, human-confirmed",
              }),
              desc: t("login.feat_ai", {
                defaultValue:
                  "Smart suggestions with confidence scores. You always have the final say.",
              }),
            },
          ].map((feat) => {
            ...
            return (
              <div key={feat.title} className="relative pl-4">
                <span
                  aria-hidden
                  className="absolute left-0 top-1 h-[14px] w-[2px] rounded-full bg-gradient-to-b from-oe-blue to-sky-500/60"
                />
                <div className="flex items-center gap-1.5">
                  <Icon
                    size={13}
                    strokeWidth={1.8}
                    className="text-oe-blue/85"
                  />
        ...
        {/* Footer */}
        <div
          className="mt-4 space-y-1 animate-stagger-in"
      ...
      <div className="relative flex items-center justify-center p-4 sm:p-6 z-10 lg:order-1 overflow-hidden">
        ...
        <div className="w-full max-w-[380px] relative z-10">
          ...
          <div
            className="relative mb-5 flex flex-col items-center animate-stagger-in"
            style={{ animationDelay: "0ms" }}
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                aria-label={t("login.brand_edit", {
                  defaultValue: "Customize logo",
                })}
                title={t("login.brand_edit", {
                  defaultValue: "Customize logo",
                })}
              >
            ...
            <p className="mt-2 text-sm text-content-tertiary">
              {t("login.workspace_tagline", {
                defaultValue: "Professional construction project workspace",
              })}
            </p>
          </div>
          ...
          <div
            className="lg:hidden mb-4 animate-stagger-in"
          ...
          >
            <div className="rounded-xl bg-gradient-to-r from-oe-blue/10 via-violet-500/10 to-emerald-500/10 border border-oe-blue/20 px-4 py-3 text-center">
              ...
              <p className="text-sm font-bold bg-gradient-to-r from-oe-blue via-violet-600 to-emerald-600 bg-clip-text text-transparent">
                {t("login.open_source_badge", {
                  defaultValue: "The #1 Open-Source Construction ERP",
                })}
              </p>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              <div
                className="flex flex-col gap-1 animate-stagger-in"
            ...
            <div
              className="mt-4 border-t border-border-light pt-3.5 animate-stagger-in"
          ...
          {/* Demo Access */}
          <div
            className="mt-3 animate-stagger-in"
          ...
          >
            <div className="login-glass-pro relative rounded-2xl overflow-hidden">
              ...
              >
                ...
                <span>
                  {t("auth.try_demo", { defaultValue: "Try demo (no signup)" })}
                </span>
                <ChevronDown
                  size={14}
                  className={`text-oe-blue/70 transition-transform duration-200 ${demoOpen ? "rotate-180" : ""}`}
                />
              </button>
              ...
              {demoOpen && (
                <div className="border-t border-border-light/60 px-3 py-2.5 space-y-1.5 animate-stagger-in">
                  {demoAccounts.map((acct) => (
                    ...
                    >
                      <div
                        className={`flex h-9 w-9 shrink-0 items-center justify-center rounded-full ${acct.color} text-white text-sm font-bold shadow-sm`}
                      >
                      ...
                      <ChevronDown
                        size={15}
                        className="text-content-quaternary -rotate-90 group-hover:text-oe-blue transition-colors shrink-0"
                      />
                    </button>
                  ))}
                </div>
          ...
          <div
            className="mt-4 grid grid-cols-2 gap-3 animate-stagger-in"
            ...
            >
              ...
              <span className="min-w-0 flex-1 leading-tight">
                ...
                <span className="block truncate text-[11px] text-oe-blue/65">
                  {t("login.community_sub", {
                    defaultValue: "Get help & discuss",
                  })}
                </span>
              </span>
              <ArrowUpRight
          ...
          <div className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-2xl border border-border-light bg-surface-elevated shadow-2xl">
            ...
            <div className="px-6 pt-5 pb-4 border-b border-border-light clear-both">
              ...
              <h3 className="text-base font-bold text-content-primary mb-2">
                {t(
                  "about.title",
                  "Professional construction cost estimation — free and open source",
                )}
              </h3>
              <p className="text-[13px] text-content-secondary leading-relaxed">
                {t(
                  "about.intro",
                  "OpenConstructionERP is a modern platform for construction cost management. It covers the full estimation workflow — from creating a bill of quantities to tendering and bid comparison. Designed for professionals worldwide, it supports international standards and works in 24 languages.",
                )}
              </p>
                ...
                {[
                  {
                    ...
                    title: t("about.cap.boq", "Bill of Quantities"),
                    desc: t(
                      "about.cap.boq_desc",
                      "Create detailed BOQ with hierarchical sections, positions, assemblies, markups (overhead, profit, VAT), and automatic totals. Works with regional classification systems or your own custom schema.",
                    ),
                  },
                  {
                    icon: Database,
                    color: "text-blue-500 bg-blue-500/10",
                    title: t("about.cap.costs", "Cost Databases"),
                    desc: t(
                      "about.cap.costs_desc",
                      "55,000+ cost items across 48 regional databases worldwide. Add your own rates, import from Excel, or build a custom database from scratch.",
                    ),
                  },
                  {
                    icon: CalendarClock,
                    color: "text-amber-500 bg-amber-500/10",
                    title: t("about.cap.schedule", "4D Scheduling"),
                    desc: t(
                  ...
                  },
                  {
                    ...
                    title: t("about.cap.costmodel", "5D Cost Model"),
                    desc: t(
                  ...
                  },
                  {
                    ...
                    title: t("about.cap.catalog", "Resource Catalog"),
                    desc: t(
                  ...
                  },
                  {
                    ...
                    title: t("about.cap.tendering", "Tendering & Bids"),
                    desc: t(
                  ...
                  },
                  {
                    ...
                    title: t("about.cap.import", "Import & Export"),
                    desc: t(
                  ...
                  },
                  {
                    ...
                    title: t("about.cap.validation", "Quality Validation"),
                    desc: t(
                  ...
                  return (
                    <div
                      key={idx}
                      className="rounded-lg border border-border-light/60 bg-surface-secondary/50 px-3 py-2.5"
                    >
                      <div className="flex items-center gap-2 mb-1">
                        <div
                          className={`flex h-6 w-6 shrink-0 items-center justify-center rounded-md ${cap.color}`}
                        >
                          <Icon size={13} />
                        </div>
                      ...
                      <p className="text-2xs text-content-tertiary leading-relaxed pl-8">
                        {cap.desc}
                      </p>
                    </div>
                  );
            ...
            <div className="px-6 py-4 border-t border-border-light">
              ...
              <div className="flex flex-wrap gap-1.5">
                {[
                  ...
                  <span
                    key={role}
                    className="inline-flex items-center rounded-full bg-oe-blue/8 px-2.5 py-1 text-2xs font-medium text-oe-blue"
                  >
                    {role}
                  </span>
                ))}
            ...
            <div className="px-6 py-4 border-t border-border-light">
              ...
              <div className="grid grid-cols-4 gap-3 text-center">
                {[
                  {
                    value: "55,719",
                    label: t("about.stat.costs", "Cost items"),
                  },
                  {
                    value: "48",
                    label: t("about.stat.regions", "Regional databases"),
                  },
                  {
                    value: "24",
                    label: t("about.stat.languages", "Languages"),
                  },
                  {
                    value: "100%",
                    label: t("about.stat.free", "Free & open source"),
                  },
                ].map((stat) => (
                  <div
                    key={stat.label}
                    className="rounded-lg bg-surface-secondary/50 py-2.5"
                  >
                    <div className="text-lg font-bold text-oe-blue">
                      {stat.value}
                    </div>
