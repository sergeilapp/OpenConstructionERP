...
const TABLE_ROWS: { t: "s" | "p"; v: string[] }[] = [
  {
    t: "s",
    v: ["300", "Structure — Building Construction", "", "", "", "", ""],
  },
  {
    t: "p",
    v: [
      "01.001",
      "Reinforced concrete C30/37, slab",
      "m\u00B3",
      "86.40",
      "\u20AC295.00",
      "\u20AC25,488",
  ...
  },
  {
    ...
    v: [
      "01.004",
      "Reinforced concrete C30/37, walls",
      "m\u00B3",
      "156.00",
      "\u20AC285.00",
      "\u20AC44,460",
...
function AnimatedTable() {
  ...
  const initTable = useCallback((node: HTMLDivElement | null) => {
    ...
    HEADERS.forEach((h, i) => {
      ...
      d.className =
        "oce-cell oce-cell-header" +
        (RIGHT_COLS.has(i) ? " oce-cell-right" : "");
      d.textContent = h;
      node.appendChild(d);
    });
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      ...
      for (let a = 0; a < ACTIVATE_COUNT; a++) {
        ...
        const idx = Array.from(cell.parentElement?.children ?? []).indexOf(
          cell,
        );
        const col = idx % 7;
        const lvl =
      ...
      for (let d = 0; d < DEACTIVATE_COUNT; d++) {
        ...
        if (
          ...
          cell.classList.contains("on-m") ||
          cell.classList.contains("on-h")
        ) {
          cell.classList.remove("on", "on-m", "on-h");
          cell.textContent = "";
        }
      ...
      <div className="oce-bg-dash-grid">
        ...
        <div className="oce-dash-cell oce-dash-wide">
          <svg viewBox="0 0 420 120" fill="none">
            ...
            {/* Planned (dashed) */}
            <polyline
              points="24,95 60,88 100,76 140,62 180,50 220,42 260,36 300,32 340,30 380,28 400,27"
              fill="none"
              stroke={c}
              strokeWidth="1.2"
              strokeDasharray="5 4"
            ...
            {/* Actual (solid) */}
            <polyline
              points="24,95 60,90 100,80 140,68 180,58 220,52 260,48 300,43 340,38 380,33 400,30"
              fill="none"
              stroke={c}
              strokeWidth="1.8"
              opacity=".5"
            ...
            {/* Area fill */}
            <polygon
              points="24,95 60,90 100,80 140,68 180,58 220,52 260,48 300,43 340,38 380,33 400,30 400,100 24,100"
              fill="url(#oceAreaFill)"
            />
            {/* Legend */}
            <line
              x1="300"
              ...
              opacity=".3"
            />
            <text x="324" y="18" fontSize="7" fill={c} opacity=".35">
              Planned
            </text>
            <line
              x1="360"
              ...
              opacity=".5"
            />
            <text x="384" y="18" fontSize="7" fill={c} opacity=".5">
              Actual
            </text>
          </svg>
        </div>
...
export function AuthBackground() {
  return (
    <div
      className="fixed inset-0 overflow-hidden pointer-events-none oce-auth-bg"
      aria-hidden="true"
    >
      <AnimatedTable />
      <DashboardGrid />
