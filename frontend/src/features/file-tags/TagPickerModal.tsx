...
const CATEGORY_OPTIONS: {
  ...
  {
    value: "discipline",
    labelKey: "files.tags.category.discipline",
    defaultLabel: "Discipline",
  },
  {
    value: "phase",
    labelKey: "files.tags.category.phase",
    defaultLabel: "Phase",
  },
  {
    value: "package",
    labelKey: "files.tags.category.package",
    defaultLabel: "Package",
  },
  {
    value: "custom",
    labelKey: "files.tags.category.custom",
    defaultLabel: "Custom",
  },
];
...
export function TagPickerModal({
  ...
  return (
    <WideModal
      ...
      onClose={onClose}
      title={
        title ?? t("files.tags.picker_title", { defaultValue: "Choose tags" })
      }
      size="md"
      footer={
        ...
        {creating ? (
          <div className="rounded-lg border border-border-light bg-surface-secondary/40 p-3 space-y-2">
            <input
              ...
              placeholder={t("files.tags.new_name", {
