    ...
    >
      ...
      >
        ...
        <div className="flex justify-end gap-2 px-5 py-3 border-t border-border">
          <button
            onClick={onClose}
            className="px-4 py-2 text-sm rounded-lg hover:bg-surface-secondary"
          >
          ...
          <button
            ...
            disabled={
              isPending || !form.email || !form.full_name || !form.password
            }
...
function ModuleAccessPanel({
  ...
  const saveMut = useMutation({
    ...
    onSuccess: () => {
      ...
      addToast({
        type: "success",
        title: t("users.access_saved", {
          defaultValue: "Access settings saved",
        }),
      });
    },
    onError: (e: Error) => {
  ...
  const setAccessLevel = (modId: string, level: ModuleAccessLevel) => {
    ...
    setModules({
      ...modules,
      [modId]: { ...cur, access: level, visible: level !== "none" },
    });
    setDirty(true);
  };
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-3 border-t border-border shrink-0">
          <div className="text-xs text-content-tertiary">
            {Object.values(modules).filter((m) => m.visible).length} /{" "}
            {MODULE_GROUPS.reduce((n, g) => n + g.modules.length, 0)}{" "}
              ...
              {ROLES.map((r) => {
                ...
                return (
                  ...
                  >
                    ...
                    {rc.label}
                    {r === currentRole && (
                      <Check size={12} className="ml-auto text-oe-blue" />
                    )}
                  </button>
                );
              })}
...
export function UserManagementPage() {
  ...
  const updateMut = useMutation({
    ...
    onSuccess: () => {
      ...
      addToast({
        type: "success",
        title: t("users.updated", { defaultValue: "User updated" }),
      });
    },
    onError: (e: Error) => {
      addToast({
    ...
    onSuccess: () => {
      ...
      addToast({
        ...
        title: t("users.invited", {
          defaultValue: "User invited successfully",
        }),
      });
    },
    onError: (e: Error) => {
  ...
  return (
    <div className="w-full animate-fade-in">
      ...
      <div className="grid grid-cols-4 gap-3 mb-5">
        {[
          {
            label: t("users.total", { defaultValue: "Total Users" }),
            value: stats.total,
            icon: Users,
            color: "text-oe-blue",
          },
          ...
          {
            label: t("users.managers", { defaultValue: "Managers" }),
            ...
            <tbody>
              {isLoading ? (
                ...
                <tr>
                  <td
                    colSpan={6}
                    className="text-center py-12 text-content-tertiary"
                  >
                    ...
                    <td className="px-4 py-2.5 text-right">
                      <div className="flex items-center justify-end gap-1">
                        <button
                          ...
                          title={t("users.module_access", {
                            defaultValue: "Module Access",
                          })}
                        >
                          <Settings2 size={13} />
          ...
          return (
            <span key={r} className="flex items-center gap-1">
              ...
              {r === "admin"
                ...
                : r === "manager"
                  ? t("users.role_manager_desc", {
                      defaultValue: "Project management",
                    })
                  : r === "editor"
                    ? t("users.role_editor_desc", {
                        defaultValue: "Create & edit",
                      })
                    : t("users.role_viewer_desc", {
