...
const QUESTIONS: QuestionDef[] = [
  ...
  },
  {
    ...
    defaultText:
      "Can you provide references for 3+ recent comparable projects?",
  },
  {
    key: "has_open_incidents",
    i18nKey: "subcontractors.prequal_q_incidents",
    defaultText:
      "Have you had any reportable HSE incidents in the past 24 months?",
    negative: true,
  },
  {
    ...
    defaultText:
      "Are there any unresolved mechanic's liens against your company?",
    negative: true,
  },
];
