...
export function RecurringSeriesDialog({
  ...
  return (
    <WideModal
      open={open}
      onClose={onClose}
      title={t("meetings.create_series", {
    ...
    >
      ...
      >
        ...
        <WideModalField
          label={t("meetings.start_date", { defaultValue: "Start date" })}
          required
        >
          <input
            type="date"
      ...
      >
        <WideModalField
          label={t("meetings.frequency", { defaultValue: "Frequency" })}
        >
          <select
            value={freq}
        ...
        <WideModalField
          label={t("meetings.count", { defaultValue: "Number of occurrences" })}
        >
          <input
            type="number"
            min={1}
            ...
            value={count}
            onChange={(e) =>
              setCount(Math.max(1, Math.min(52, Number(e.target.value) || 1)))
            }
            className={inputCls}
          />
        </WideModalField>
        ...
        <WideModalField
          label={t("meetings.materialize_until", {
            defaultValue: "Materialise until",
          })}
          span={2}
        >
          <input
