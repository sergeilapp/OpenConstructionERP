      ...
      >
        ...
        <div className="px-6 py-4 space-y-5">
          ...
          <div className="flex items-center gap-2 pt-2 pb-1">
            ...
            <span className="text-xs font-semibold uppercase tracking-wider text-content-tertiary">
              {t("inspections.section_details", {
                defaultValue: "Inspection Details‌⁠‍",
              })}
            </span>
          ...
          <div className="flex items-center gap-2 pt-2 pb-1">
            ...
            <span className="text-xs font-semibold uppercase tracking-wider text-content-tertiary">
              {t("inspections.section_schedule", {
                defaultValue: "Schedule & Assignment",
              })}
            </span>
            <div className="flex-1 h-px bg-border-light" />
          </div>
        ...
        <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-border-light">
          ...
          >
            ...
            <span>
              {isEdit
                ? t("inspections.save_changes", {
                    defaultValue: "Save Changes",
                  })
                : t("inspections.create_inspection", {
...
const InspectionRow = React.memo(function InspectionRow({
  ...
  const typeCfg =
    INSPECTION_TYPE_COLORS[inspection.inspection_type] ?? "neutral";
  ...
  const editDisabled =
    ...
    (inspection.status as string) === "failed";
  ...
  return (
    <div className="border-b border-border-light last:border-b-0">
      ...
      <div
        ...
        aria-label={t("inspections.toggle_details", {
          defaultValue: "Toggle inspection details",
        })}
        className={clsx(
      ...
      >
        ...
        {resultCfg ? (
          <Badge
            variant={resultCfg.variant}
            size="sm"
            className={resultCfg.cls}
          >
          ...
          <span className="text-xs text-content-tertiary w-16 text-center">
            {"\u2014"}
          </span>
        )}
              ...
              (inspection.result === "fail" ||
                ...
                <div className="flex gap-2">
                  ...
                  >
                    ...
                    {t("inspections.create_defect", {
                      defaultValue: "Create Punchlist Item",
                    })}
                  </Button>
                  <Button
                    variant="ghost"
                  ...
                  >
                    ...
                    {t("inspections.create_ncr", {
                      defaultValue: "Create NCR",
                    })}
                  </Button>
                </div>
              )}
                ...
                title={
                  editDisabled
                    ? t("inspections.edit_locked", {
                        defaultValue:
                          "Completed or failed inspections cannot be edited",
                      })
...
export function InspectionsPage() {
      ...
      addToast(
        {
          ...
          message: isFail
            ? t("inspections.completed_fail_hint", {
                defaultValue: "Inspection failed. Create a punchlist item?",
              })
            : undefined,
          action:
            isFail && data?.id
              ? {
                  label: t("inspections.create_defect", {
                    defaultValue: "Create Punchlist Item",
                  }),
  ...
  const exportMut = useMutation({
    ...
    onSuccess: () =>
      addToast({
        type: "success",
        title: t("inspections.export_success", {
  ...
  const handleComplete = useCallback(
    async (id: string) => {
      const ok = await confirm({
        title: t("inspections.confirm_complete_title", {
          defaultValue: "Complete inspection?",
        }),
        message: t("inspections.confirm_complete_msg", {
          defaultValue: "This inspection will be marked as completed.",
        }),
        confirmLabel: t("inspections.mark_complete", {
  ...
  const handleDeleteInspection = useCallback(
    async (id: string) => {
      const ok = await confirm({
        title: t("inspections.confirm_delete_title", {
  ...
  const createDefectMut = useMutation({
    ...
    onSuccess: (data) => {
      addToast({
        type: "success",
        title: t("inspections.defect_created", {
          defaultValue: "Punchlist item created",
        }),
        message: data.title,
      });
    },
  ...
  return (
    <div className="w-full animate-fade-in">
        ...
        <div className="flex items-center gap-2 shrink-0">
          {!routeProjectId && projects.length > 0 && (
            <select
              ...
              aria-label={t("inspections.select_project", {
                defaultValue: "Project...",
              })}
              className={inputCls + " !h-8 !text-xs max-w-[180px]"}
            >
              <option value="" disabled>
                {t("inspections.select_project", {
                  defaultValue: "Project...",
                })}
              </option>
              {projects.map((p) => (
      ...
      <SectionIntro
        ...
        links={[
          {
            label: t("inspections.intro_link_punch", {
          ...
          {
            label: t("inspections.intro_link_qms", {
              defaultValue: "QMS overview",
            }),
      ...
      {projectId ? (
          ...
          <div className="mb-6 flex flex-col sm:flex-row sm:items-center gap-3">
            ...
            <div className="relative flex-1 max-w-sm">
              ...
              <input
                ...
                aria-label={t("inspections.search_placeholder", {
                  defaultValue: "Search inspections...",
                })}
            ...
            <div className="relative">
              <select
                ...
                aria-label={t("inspections.filter_all_statuses", {
              ...
              >
                <option value="">
                  {t("inspections.filter_all_statuses", {
                    defaultValue: "All Statuses",
                  })}
                </option>
              ...
              <EmptyState
                ...
                title={
                  searchQuery || statusFilter
                    ? t("inspections.no_results", {
                        defaultValue: "No matching inspections",
                      })
                    : t("inspections.no_inspections", {
        ...
        <EmptyState
          icon={<ClipboardCheck size={28} strokeWidth={1.5} />}
          title={t("inspections.no_project", {
            defaultValue: "No project selected",
          })}
          description={t("inspections.select_project", {
            defaultValue:
              "Open a project first to view and manage inspections.",
          })}
        />
      )}
      ...
      {(showCreateModal || editingInspection) && (
        <CreateInspectionModal
          ...
          isPending={
            editingInspection ? editMut.isPending : createMut.isPending
          }
