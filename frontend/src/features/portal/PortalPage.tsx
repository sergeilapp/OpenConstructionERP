        ...
        <div className="min-w-0 flex-1">
          <p className="text-sm font-semibold text-content-primary">
            {t("portal.intro_title", {
              defaultValue:
                "Give outsiders exactly what they need — nothing more‌⁠‍",
            })}
          </p>
        ...
        items={[
          {
            label: t("portal.title", {
              defaultValue: "Customer / Buyer Portal",
            }),
          },
        ]}
      />
        ...
        <nav className="flex gap-1 -mb-px">
          {(
            [
              {
                id: "users",
                label: t("portal.users", { defaultValue: "Users" }),
                icon: Users,
              },
              {
                id: "access_rules",
                label: t("portal.access_rules", {
                  defaultValue: "Access Rules",
                }),
                icon: ShieldCheck,
              },
              {
          ...
          {rows.map((u) => (
            ...
            >
              ...
              <td className="px-4 py-2 text-xs text-content-secondary">
                {u.last_login_at ? (
                  <DateDisplay value={u.last_login_at} />
                ) : (
                  "—"
                )}
              </td>
...
function AccessRuleTable({
  ...
  const revokeMut = useMutation({
    ...
    onSuccess: () => {
      ...
      addToast({
        type: "success",
        title: t("portal.access_revoked", {
          defaultValue: "Access rule revoked",
        }),
      });
    },
  ...
  if (rows.length === 0) {
    return (
      <EmptyState
        ...
        title={t("portal.empty_rules", {
          defaultValue: "No access rules granted yet",
        })}
              ...
              <tr key={r.id} className="border-t border-border-light">
                ...
                <td className="px-4 py-2 text-right">
                  <Button
                    ...
                    icon={<Ban size={12} />}
                    loading={
                      revokeMut.isPending && revokeMut.variables === r.id
                    }
  ...
  if (rows.length === 0) {
    return (
      <EmptyState
        ...
        title={t("portal.empty_audit", {
          defaultValue: "No document access yet",
        })}
          ...
          {rows.map((e) => {
            ...
            return (
              <tr key={e.id} className="border-t border-border-light">
                ...
                <td className="px-4 py-2 text-xs text-content-secondary">
                  {e.occurred_at ? (
                    <DateDisplay value={e.occurred_at} />
                  ) : (
        ...
        <div className="space-y-4 p-5">
          <div className="grid grid-cols-2 gap-3 text-sm">
            ...
            <Field
              ...
              value={
                user.invited_at ? <DateDisplay value={user.invited_at} /> : "—"
              }
            />
            <Field
              ...
              value={
                user.last_login_at ? (
                  <DateDisplay value={user.last_login_at} />
                ) : (
                  "—"
                )
              }
            />
            <Field
              label={t("portal.failed_logins", {
                defaultValue: "Failed logins",
              })}
          ...
          {auditEntries.length > 0 && (
            <div className="border-t border-border-light pt-4">
              <p className="text-xs font-semibold uppercase tracking-wide text-content-secondary mb-2">
                {t("portal.recent_access", {
                  defaultValue: "Recent document access",
                })}
              </p>
      ...
      <WideModalSection columns={2}>
        ...
        >
          <input
            ...
            onChange={(e) =>
              setForm({ ...form, redirect_path: e.target.value })
            }
            className={inputCls}
      ...
      >
        ...
        >
          <select
            ...
            onChange={(e) =>
              setForm({ ...form, portal_user_id: e.target.value })
            }
            className={inputCls}
          >
            <option value="">
        ...
        >
          ...
          >
            <option value="project">
              {t("portal.rt_project", { defaultValue: "Project" })}
            </option>
            <option value="development">
              {t("portal.rt_development", { defaultValue: "Development" })}
            </option>
            <option value="document">
              {t("portal.rt_document", { defaultValue: "Document" })}
            </option>
            <option value="ticket">
              {t("portal.rt_ticket", { defaultValue: "Service ticket" })}
            </option>
            <option value="invoice">
              {t("portal.rt_invoice", { defaultValue: "Invoice" })}
            </option>
          </select>
        </WideModalField>
        <WideModalField
        ...
        {form.resource_type === "project" ? (
          <WideModalField
            ...
            hint={t("portal.project_hint", {
              defaultValue:
                "The portal user will only see the data inside this project.",
            })}
            span={2}
          >
            <select
          ...
          <WideModalField
            ...
            hint={t("portal.resource_id_hint", {
              defaultValue:
                "Open the resource in the app and copy the UUID from the URL.",
            })}
            span={2}
          >
            <input
