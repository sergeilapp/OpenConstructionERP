...
const NCR_SEVERITIES: NCRSeverity[] = [
  "critical",
  "major",
  "minor",
  "observation",
...
const NCR_TYPE_CARD_CONFIG: Record<
  NCRType,
...
const SEVERITY_CARD_CONFIG: Record<
  NCRSeverity,
  { icon: React.ElementType; color: string; ringColor: string }
> = {
  critical: {
    icon: AlertOctagon,
    color:
      "text-red-700 bg-red-50 border-red-300 dark:text-red-400 dark:bg-red-950/30 dark:border-red-800",
  ...
  observation: {
    icon: Info,
    color:
      "text-gray-500 bg-gray-50 border-gray-200 dark:text-gray-400 dark:bg-gray-800/50 dark:border-gray-700",
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-lg animate-fade-in">
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-label={t("ncr.new_ncr", { defaultValue: "New NCR‌⁠‍" })}
      >
        {/* Header */}
        ...
        <div className="px-6 py-4 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              placeholder={t("ncr.title_placeholder", {
                defaultValue:
                  "e.g. Concrete strength below specification at Column C3",
              })}
              className={clsx(
                inputCls,
                titleError &&
          ...
          <div>
            ...
            <textarea
              ...
              placeholder={t("ncr.description_placeholder", {
                defaultValue:
                  "Describe the non-conformance in detail: what was observed, where, and what specification was not met...",
              })}
            />
            {descError && (
              <p className="mt-1 text-xs text-semantic-error">
                {t("ncr.description_required", {
          ...
          <div>
            <label
              htmlFor="ncr-root-cause"
              className="block text-sm font-medium text-content-primary mb-1.5"
            >
              {t("ncr.field_root_cause", {
                defaultValue: "Root Cause (if known)",
              })}
            </label>
            <textarea
              id="ncr-root-cause"
              ...
              placeholder={t("ncr.root_cause_placeholder", {
                defaultValue:
                  "Preliminary analysis of why the non-conformance occurred...",
              })}
            />
          </div>
        </div>
      ...
      >
        ...
        <Badge variant={typeCfg} size="sm">
          {t(`ncr.type_${ncr.ncr_type}`, {
            defaultValue:
              ncr.ncr_type.charAt(0).toUpperCase() + ncr.ncr_type.slice(1),
          })}
        </Badge>
      ...
      {expanded && (
        <div className="px-4 pb-4 pl-12 space-y-3 animate-fade-in">
          ...
          {ncr.corrective_action && (
            <div className="rounded-lg bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 p-3">
              <p className="text-xs text-blue-700 dark:text-blue-400 mb-1 font-medium uppercase tracking-wide">
                {t("ncr.label_corrective_action", {
                  defaultValue: "Corrective Action",
                })}
              </p>
              <p className="text-sm text-content-primary whitespace-pre-wrap">
                {ncr.corrective_action}
          ...
          {ncr.preventive_action && (
            <div className="rounded-lg bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 p-3">
              <p className="text-xs text-green-700 dark:text-green-400 mb-1 font-medium uppercase tracking-wide">
                {t("ncr.label_preventive_action", {
                  defaultValue: "Preventive Action",
                })}
              </p>
              <p className="text-sm text-content-primary whitespace-pre-wrap">
                {ncr.preventive_action}
          ...
          {ncr.change_order_id && (
            ...
            >
              ...
              <span className="text-sm font-medium text-blue-700 dark:text-blue-300">
                {t("ncr.linked_change_order", {
                  defaultValue: "Linked to Change Order",
                })}
              </span>
              ...
              <ChevronRight
                size={14}
                className="ml-auto text-blue-400 dark:text-blue-500"
              />
            </div>
          )}
          ...
          <div className="flex items-center gap-4 text-xs text-content-tertiary flex-wrap">
            {ncr.location && (
              <span>
                {t("ncr.label_location", { defaultValue: "Location" })}:{" "}
                {ncr.location}
              </span>
            )}
            <span>
  ...
  const handleClose = useCallback(
    async (id: string) => {
      const ok = await confirm({
        ...
        message: t("ncr.confirm_close_msg", {
          defaultValue: "This non-conformance report will be closed.",
        }),
  ...
  return (
    <div className="w-full animate-fade-in">
        ...
        <div className="flex items-center gap-2 shrink-0">
          {!routeProjectId && projects.length > 0 && (
            <select
              ...
              aria-label={t("ncr.select_project", {
      ...
      <SectionIntro
        ...
        links={[
          {
            label: t("ncr.intro_link_inspections", {
              defaultValue: "Inspections",
            }),
            onClick: () => navigate("/inspections"),
          },
          {
            label: t("ncr.intro_link_changeorders", {
      ...
      {projectId ? (
          ...
          <div className="mb-6 flex flex-col sm:flex-row sm:items-center gap-3">
            ...
            <div className="relative flex-1 max-w-sm">
              ...
              <input
                ...
                aria-label={t("ncr.search_placeholder", {
                  defaultValue: "Search NCRs...",
                })}
            ...
            <div className="relative">
              <select
                value={statusFilter}
                onChange={(e) =>
                  setStatusFilter(e.target.value as NCRStatus | "")
                }
                aria-label={t("ncr.filter_all_statuses", {
        ...
        <EmptyState
          ...
          description={t("ncr.select_project", {
            defaultValue: "Open a project first to view and manage NCRs.",
          })}
        />
      )}
