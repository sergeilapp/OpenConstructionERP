...
export function StylesLabPage() {
  const [section, setSection] = useState<
    "headings" | "buttons" | "icons" | "tags" | "backgrounds"
  >("headings");
...
function Specimen({
  ...
  return (
    <div className="group relative rounded-[12px] border border-border-light bg-surface-primary p-6 transition-all duration-normal ease-oe hover:border-border hover:shadow-md">
      ...
      <p className="mt-1 text-xs text-content-tertiary leading-relaxed min-h-[2.5em]">
        {note}
      </p>
...
function HeadingsSection() {
  return (
    <>
      <SectionTitle sub="text-display family · 12 directions">
        Headings
      </SectionTitle>
      <Grid>
        <Specimen
          ...
          name="Apple Plain"
          family="Default"
          note="Текущий OE: крупный semibold, tight tracking. Спокойный baseline."
        >
        ...
        <Specimen
          ...
          name="Gradient Sweep"
          family="Premium"
          note="Анимированный градиент через bg-clip-text. Для главных страниц и AI-фичей."
        >
        ...
        <Specimen
          no={3}
          name="Eyebrow + Display"
          family="Editorial"
          note="Маленький uppercase-лейбл + крупный заголовок. Журнальная типографика."
        >
          <div className="text-center">
            <div className="text-2xs uppercase tracking-[0.22em] text-oe-blue font-semibold">
              Phase 02 · Cost Plan
            </div>
            <h3 className="mt-2 text-2xl font-semibold tracking-tight text-content-primary">
              Project overview
            </h3>
          </div>
        </Specimen>
        ...
        <Specimen
          ...
          family="Structural"
          note="Заголовок с цветной чертой снизу. Маркирует секции без иконок."
        >
          <div>
            <h3 className="text-2xl font-semibold tracking-tight text-content-primary">
              Project overview
        ...
        <Specimen
          no={5}
          name="Numbered Watermark"
          family="Editorial"
          note="Огромная цифра-водяной-знак позади. Для wizard / пошаговых страниц."
        >
          <div className="relative">
            <span
              aria-hidden
              className="absolute -top-6 -left-2 text-7xl font-bold text-content-primary/5 leading-none select-none"
            >
              03
            </span>
            <h3 className="relative text-2xl font-semibold tracking-tight text-content-primary">
              Project overview
            </h3>
          </div>
        </Specimen>
        ...
        <Specimen
          no={6}
          name="Icon + Heading + Meta"
          family="Functional"
          note="Иконка-чип, заголовок, мета-строка. Шаблон для dashboard-tile."
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-lg font-semibold tracking-tight text-content-primary leading-tight">
                Project overview
              </h3>
              <div className="text-xs text-content-tertiary">
                12 BOQs · 4 active phases
              </div>
            </div>
          </div>
        </Specimen>
        ...
        <Specimen
          ...
          name="Glow Halo"
          family="Hero"
          note="Текст с мягким размытым свечением. Для splash, hero, AI-страниц."
        >
          <h3 className="text-2xl font-semibold tracking-tight text-oe-blue [text-shadow:0_0_24px_rgb(0_113_227_/_45%)]">
            Project overview
          </h3>
        </Specimen>
        ...
        <Specimen
          ...
          family="Technical"
          note="Mono-префикс как code-метка + sans-заголовок. Для тех-страниц."
        >
          <div className="flex items-baseline gap-3">
            <span className="font-mono text-xs px-1.5 py-0.5 rounded-[5px] bg-surface-tertiary text-content-tertiary border border-border-light">
              v2.9.36
            </span>
            <h3 className="text-2xl font-semibold tracking-tight text-content-primary">
              Project overview
        ...
        <Specimen
          ...
          name="Outline Stroke"
          family="Display"
          note="Только обводка, без заливки. Для hero и empty-state. -webkit-text-stroke."
        >
        ...
        <Specimen
          ...
          name="Mixed Weights"
          family="Editorial"
          note="Лёгкий вес для контекста + жирный градиент для имени. Заметнее, чем плоский semibold."
        >
          <h3 className="text-2xl tracking-tight">
            <span className="font-light text-content-tertiary">Project </span>
            <span className="font-bold bg-gradient-to-r from-oe-blue to-fuchsia-500 bg-clip-text text-transparent">
              overview
            </span>
          </h3>
        </Specimen>
        ...
        <Specimen
          ...
          name="Ultra Display"
          family="Hero"
          note="Максимальный размер + жирный вес + ультра-tight tracking. Только для splash/landing."
        >
        ...
        <Specimen
          ...
          name="With Sparkline"
          family="Analytics"
          note="Заголовок + крошечный график рядом. Для аналитики и live-метрик."
        >
          <div className="flex items-end gap-3">
            ...
            <svg viewBox="0 0 60 24" className="h-6 w-16 text-semantic-success">
              <polyline
                points="0,18 10,15 20,16 30,10 40,12 50,5 60,7"
                fill="none"
                stroke="currentColor"
                strokeWidth="2"
                strokeLinecap="round"
  ...
  return (
    <>
      ...
      <Grid>
        <Specimen
          no={1}
          name="Apple Liquid (default)"
          family="Current"
          note="Текущий OE primary. Радиус снижен до 10px (было 20). Лёгкий scale на hover."
        >
        ...
        <Specimen
          no={2}
          name="Liquid Glass (WWDC25)"
          family="Modern"
          note="Frosted glass + верхний rim-highlight + внутренняя тень. Apple iOS 26 / visionOS."
        >
        ...
        <Specimen
          ...
          name="Gradient Mesh"
          family="Premium"
          note="Анимированный градиент. Для главного CTA, AI-кнопок, Pro-плана."
        >
        ...
        <Specimen
          ...
          name="Neon Glow"
          family="Futuristic"
          note="Тёмный solid + цветное свечение. На тёмном фоне — chat, advisor."
        >
        ...
        <Specimen
          no={5}
          name="Brutalist Hard Shadow"
          family="Bold"
          note="Чёрный border + offset-shadow. Маркетинг, dev-инструменты. r=8px."
        >
        ...
        <Specimen
          no={6}
          name="Animated Conic Border"
          family="Premium"
          note="Конический градиент вращается по периметру. Признак pro/premium."
        >
          <span className="relative inline-flex p-[1.5px] rounded-[10px] overflow-hidden">
            <span
              aria-hidden
              className="absolute inset-[-100%] animate-[spin_4s_linear_infinite] bg-[conic-gradient(from_0deg,#0071e3,#a855f7,#06b6d4,#0071e3)]"
            />
        ...
        <Specimen
          ...
          name="Bevel Hairline"
          family="SaaS Modern"
          note="Тонкая верхняя hairline + inner bottom shadow. Linear / Arc style."
        >
        ...
        <Specimen
          ...
          name="3D Press"
          family="Tactile"
          note="Тёмный bottom-edge даёт физическое нажатие. Stripe style."
        >
        ...
        <Specimen
          no={9}
          name="Outline Refined"
          family="Minimal"
          note="Linear-style тонкий border, мягкая заливка на hover. Для secondary actions."
        >
        ...
        <Specimen
          ...
          name="Shimmer Sweep"
          family="Attention"
          note="Полоса света бежит по поверхности на hover. Для важного редкого CTA."
        >
          <button className="group relative inline-flex h-10 items-center gap-2 px-5 rounded-[10px] text-sm font-medium text-white bg-content-primary overflow-hidden">
            <span
              aria-hidden
              className="absolute inset-0 -translate-x-full group-hover:translate-x-full bg-gradient-to-r from-transparent via-white/30 to-transparent transition-transform duration-1000 ease-out"
            />
        ...
        <Specimen
          no={11}
          name="Soft Inset (pressed)"
          family="Calm"
          note="Кнопка как будто утоплена в поверхность. Для toggle-like state, фильтров."
        >
        ...
        <Specimen
          ...
          family="Alert"
          note="Пульсирующее цветное кольцо вокруг. Для notification-actions, новых фичей."
        >
        ...
        <Specimen
          no={13}
          name="Magnetic Underline"
          family="Text-only"
          note="Текстовая кнопка с анимированным подчёркиванием. Для inline CTA, ссылок-действий."
        >
        ...
        <Specimen
          ...
          name="Segmented Pill"
          family="iOS Native"
          note="iOS-style segmented control. Для view-switchers (List/Grid/Map)."
        >
          <div className="inline-flex h-9 items-center rounded-[8px] bg-surface-tertiary p-0.5 ring-1 ring-inset ring-border-light">
            <button className="h-8 px-3 text-xs font-medium rounded-[6px] bg-surface-primary text-content-primary shadow-sm">
              List
            </button>
            <button className="h-8 px-3 text-xs font-medium rounded-[6px] text-content-tertiary hover:text-content-primary">
              Grid
            </button>
            <button className="h-8 px-3 text-xs font-medium rounded-[6px] text-content-tertiary hover:text-content-primary">
              Map
    ...
    <>
      ...
      <Grid>
        <Specimen
          ...
          name="Plain Stroke"
          family="Default"
          note="Чистая Lucide-иконка, текущий стиль. Для inline-использования в тексте."
        >
          <Hammer
        ...
        <Specimen
          ...
          name="Soft Chip"
          family="Functional"
          note="Иконка в мягко-окрашенном квадрате. Dashboard tile, feature card."
        >
        ...
        <Specimen
          ...
          name="Gradient Chip"
          family="Premium"
          note="Цветной градиент + белая иконка. Для AI и premium-фичей."
        >
        ...
        <Specimen
          ...
          name="Ring Border"
          family="Status"
          note="Кольцо + цвет внутри. Для статусных индикаторов (passed, blocked)."
        >
        ...
        <Specimen
          ...
          name="Glow Halo"
          family="Hero"
          note="Иконка + мягкое цветное свечение позади. Для splash и hero-блоков."
        >
          <div className="relative">
            <div
              aria-hidden
              className="absolute inset-0 -m-2 rounded-full bg-fuchsia-500/30 blur-xl"
            />
        ...
        <Specimen
          ...
          name="Duotone Stack"
          family="Editorial"
          note="Две иконки наслоены со смещением. Декоративно, для empty states."
        >
          <div className="relative h-12 w-12">
            <Boxes
              className="absolute inset-0 m-auto h-10 w-10 text-oe-blue/30"
              strokeWidth={1.5}
            />
            <Box
              className="absolute inset-0 m-auto h-7 w-7 translate-x-1.5 translate-y-1.5 text-oe-blue"
              strokeWidth={1.75}
            />
          </div>
        </Specimen>
        ...
        <Specimen
          no={7}
          name="Pill with Label"
          family="Metadata"
          note="Иконка + текст в pill. Chips для типа файла, источника, тэга."
        >
        ...
        <Specimen
          ...
          name="Inset Depth"
          family="Tactile"
          note="Внутренняя тень даёт «выгравированную» глубину. Toggle/option-grid."
        >
        ...
        <Specimen
          ...
          name="SF Symbol Ramp"
          family="iOS Native"
          note="Серый градиент-ramp с тёмным окантом. iOS Settings-icon style."
        >
        ...
        <Specimen
          ...
          name="Glass Floating"
          family="Modern"
          note="Frosted-glass chip с rim highlight. Поверх изображений / 3D-вьюера."
        >
        ...
        <Specimen
          no={11}
          name="Stacked Layers (3D)"
          family="Editorial"
          note="Несколько слоёв со сдвигом — псевдо-3D глубина. Для feature-карточек."
        >
          <div className="relative h-12 w-12">
        ...
        <Specimen
          ...
          name="Pulse Ring"
          family="Realtime"
          note="Анимированное расходящееся кольцо. Live-status, активное соединение."
        >
          <div className="relative">
            <span
              aria-hidden
              className="absolute inset-0 rounded-full bg-semantic-success/40 animate-ping"
            />
...
function TagsSection() {
  return (
    <>
      <SectionTitle sub="13 directions · pills + squircles">
        Tags & Badges
      </SectionTitle>
      <Grid>
        <Specimen
          no={1}
          name="Soft Pill (current Badge)"
          family="Default"
          note="Текущий OE Badge: мягкий фон + текст в том же тоне. Универсальный."
        >
          <span className="inline-flex h-6 items-center gap-1.5 rounded-full px-2 text-xs font-medium bg-semantic-success-bg text-semantic-success">
            Approved
          </span>
        </Specimen>
        ...
        <Specimen
          ...
          name="Solid Bold"
          family="Emphatic"
          note="Насыщенный цвет, белый текст. Для жёстких алертов: blocked, overdue."
        >
        ...
        <Specimen
          ...
          name="Outline Ghost"
          family="Minimal"
          note="Только border + текст, прозрачный фон. Для второстепенных категорий."
        >
          <span className="inline-flex h-6 items-center gap-1.5 rounded-full px-2.5 text-xs font-medium text-content-secondary border border-border">
            Draft
          </span>
        </Specimen>
        ...
        <Specimen
          ...
          name="Dot + Label"
          family="Status"
          note="Цветная точка + plain текст. Минимум шума, читается как «status:value»."
        >
        ...
        <Specimen
          ...
          name="Gradient Pill"
          family="Premium"
          note="Анимированный градиент. Для «AI-suggested», «Pro», «New»."
        >
        ...
        <Specimen
          ...
          name="Live Pulse Dot"
          family="Realtime"
          note="Пульсирующая точка с расходящимся кольцом. «Live», «Running», presence."
        >
        ...
        <Specimen
          ...
          name="Mono Code Chip"
          family="Technical"
          note="Monospace + рамка как kbd. r=5px. Версии, IDs, error codes."
        >
        ...
        <Specimen
          ...
          name="Glass Frosted"
          family="Modern"
          note="Backdrop-blur на цветном фоне. Для overlays поверх 3D-вьюера."
        >
          <div className="relative w-full grid place-items-center">
        ...
        <Specimen
          ...
          name="Removable Chip"
          family="Functional"
          note="С кнопкой-крестиком. Фильтры, multi-select, applied search terms."
        >
          <span className="inline-flex h-7 items-center gap-1.5 rounded-full pl-3 pr-1 text-xs font-medium text-oe-blue bg-oe-blue/10 ring-1 ring-inset ring-oe-blue/20">
            ...
            <button
              className="grid h-5 w-5 place-items-center rounded-full hover:bg-oe-blue/20 transition-colors"
        ...
        <Specimen
          ...
          name="Squircle Solid"
          family="iOS Native"
          note="Notion/iOS Section-style: пастельный блок с r=6px. Для категорий и tag-таксономий."
        >
          <div className="flex items-center gap-1.5">
            <span className="inline-flex h-6 items-center rounded-[6px] px-2 text-2xs font-semibold uppercase tracking-wider bg-violet-100 text-violet-700 dark:bg-violet-500/20 dark:text-violet-300">
              Concrete
            </span>
            <span className="inline-flex h-6 items-center rounded-[6px] px-2 text-2xs font-semibold uppercase tracking-wider bg-amber-100 text-amber-800 dark:bg-amber-500/20 dark:text-amber-300">
              Rebar
            </span>
            <span className="inline-flex h-6 items-center rounded-[6px] px-2 text-2xs font-semibold uppercase tracking-wider bg-emerald-100 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-300">
              Finish
            </span>
          </div>
        </Specimen>
        ...
        <Specimen
          ...
          name="Trend Arrow"
          family="Analytics"
          note="Цифра + стрелка тренда. Для KPI-карточек: рост / падение / no change."
        >
        ...
        <Specimen
          ...
          name="Counter Pip"
          family="Notification"
          note="Круглый цифровой badge поверх иконки. Inbox, queue, pending count."
        >
          <div className="relative">
        ...
        <Specimen
          ...
          family="AI"
          note="Pill с пробегающим световым shimmer. «Thinking…», «Indexing…», «Processing…»."
        >
          <span className="relative inline-flex h-6 items-center gap-1.5 overflow-hidden rounded-full px-2.5 text-xs font-medium text-fuchsia-700 dark:text-fuchsia-200 bg-fuchsia-100 dark:bg-fuchsia-500/15 ring-1 ring-inset ring-fuchsia-300/40">
            ...
            />
            <Lightbulb className="relative h-3 w-3" />{" "}
      ...
      <div className="mt-10 rounded-[12px] border border-border-light bg-surface-primary p-6">
        <div className="text-2xs uppercase tracking-[0.16em] text-content-tertiary font-medium">
          Composition · realistic row
        </div>
        <div className="mt-3 flex flex-wrap items-center gap-2">
          <span className="inline-flex h-6 items-center gap-1.5 rounded-full bg-semantic-success-bg px-2 text-xs font-medium text-semantic-success">
            Approved
          </span>
          <span className="inline-flex h-6 items-center gap-2 text-xs font-medium text-content-primary">
            <span className="h-2 w-2 rounded-full bg-semantic-warning ring-2 ring-semantic-warning/20" />
            Waiting client
          </span>
          <span className="inline-flex h-6 items-center rounded-[5px] px-1.5 font-mono text-2xs text-content-primary bg-surface-tertiary border border-border-light">
            v2.9.36
          </span>
          <span className="inline-flex h-6 items-center rounded-[6px] px-2 text-2xs font-semibold uppercase tracking-wider bg-violet-100 text-violet-700 dark:bg-violet-500/20 dark:text-violet-300">
            Concrete
...
function BgSpecimen({
  ...
  return (
    <div className="rounded-[12px] border border-border-light bg-surface-primary overflow-hidden transition-all duration-normal ease-oe hover:border-border hover:shadow-md">
      ...
      <div
        className={[
          "relative h-[240px] overflow-hidden border-t border-border-light",
          bgClass ?? "",
        ].join(" ")}
        style={bgStyle}
      >
...
function SampleContent({ dark = false }: { dark?: boolean }) {
  ...
  const cardBg = dark
    ? "bg-white/8 backdrop-blur-xl ring-white/15"
    : "bg-surface-primary/85 backdrop-blur-md ring-border-light/60";
  const btnBg = dark
  ...
  return (
    <div className="relative h-full p-6 flex flex-col justify-between">
      <div>
        <div
          className={[
            "text-2xs uppercase tracking-[0.18em] font-medium",
            dark ? "text-white/55" : "text-content-tertiary",
          ].join(" ")}
        >
          Phase 02 · Cost plan
        </div>
        ...
        <p
          className={["mt-1 text-xs leading-relaxed max-w-md", subColor].join(
            " ",
          )}
        >
      ...
      <div className="flex items-center gap-2">
        <button
          className={[
            "inline-flex h-8 items-center gap-1.5 px-3 rounded-[8px] text-xs font-medium shadow-sm",
            btnBg,
          ].join(" ")}
        >
...
function BackgroundsSection() {
  ...
  return (
    <>
      <SectionTitle sub="12 page-level treatments · content overlay shows readability">
        Backgrounds
      </SectionTitle>
      <div className="grid gap-5 lg:grid-cols-2">
        ...
        <BgSpecimen
          no={2}
          name="Dot Grid (subtle)"
          family="Linear / Vercel"
        ...
        >
          <div className="absolute inset-0 bg-surface-secondary" />
          <svg
            className="absolute inset-0 h-full w-full text-oe-blue/15"
            viewBox="0 0 800 240"
        ...
        >
          ...
          <div className="absolute inset-0" aria-hidden>
            {[
              ...
              <span
                key={i}
                className="absolute h-px w-px rounded-full bg-white shadow-[0_0_4px_1px_rgba(255,255,255,0.6)]"
                style={{ left: l, top: t }}
              />
            ))}
          </div>
