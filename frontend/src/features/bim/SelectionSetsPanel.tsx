...
export default function SelectionSetsPanel({
  ...
  useEffect(() => {
    ...
    const tick = () =>
      setCurrentSelectionCount(selectionManager.getSelectedIds().length);
    tick();
  ...
  const handlePickColor = useCallback(
    (set: SelectionSet, hex: string | undefined) => {
                ...
                >
                  <div className="flex items-center gap-1.5 min-w-0">
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        setColorPickerId(isPickingColor ? null : set.id)
                      }
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    >
                      <Plus size={10} />
                      {t("bim.selection_sets_add_short", {
                        defaultValue: "Add",
                      })}
                    </button>
                    <button
                      ...
                      disabled={
                        !selectionManager || currentSelectionCount === 0
                      }
