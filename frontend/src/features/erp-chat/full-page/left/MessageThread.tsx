  ...
  if (messages.length === 0) {
      ...
      return (
        ...
        >
          ...
          >
            ...
            >
              {t("chat.onboarding_title", {
                defaultValue: "AI assistant is not configured yet‌⁠‍",
              })}
            </div>
            <div
              style={{
    ...
    return (
      ...
      >
        ...
        <span>
          {t("chat.empty_title", {
            defaultValue: "Start a conversation with the ERP AI Assistant‌⁠‍",
          })}
        </span>
        <span style={{ fontSize: 12 }}>
          {t("chat.empty_subtitle", {
            defaultValue: "Ask about projects, BOQs, costs, or validation‌⁠‍",
          })}
        </span>
      </div>
    );
  ...
  return (
    ...
    >
      {messages.map((msg, idx) => {
        ...
        return (
          <MessageBubble key={msg.id} message={msg} isStreaming={showCursor} />
        );
      })}
      <div ref={bottomRef} />
    </div>
