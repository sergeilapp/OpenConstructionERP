  ...
  return (
    <Card className={clsx("p-4", className)}>
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
        ...
        <label className="block">
          <span className="block text-2xs font-medium text-content-secondary mb-1">
            {t("costs.regional_adjust.base_rate", {
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-2xs text-content-tertiary">
              {t("costs.regional_adjust.adjusted", {
                defaultValue: "Adjusted rate",
              })}
            </div>
      ...
      {onApplyPreview && (
        <div className="mt-3 flex justify-end">
          ...
          >
            {t("costs.regional_adjust.apply", {
              defaultValue: "Use this rate",
            })}
          </button>
        </div>
      )}
