            ...
            <thead>
              <tr className="text-left text-content-tertiary text-xs uppercase">
                <th className="px-2 py-2">
                  {t("clash.rules.disc_a", { defaultValue: "Discipline A" })}
                </th>
                <th className="px-2 py-2">
                  {t("clash.rules.disc_b", { defaultValue: "Discipline B" })}
                </th>
                <th className="px-2 py-2 w-32">
                  {t("clash.rules.tolerance", {
                                ...
                                ? {
                                    ...
                                    severity_override:
                                      e.target.value === ""
                                        ? null
                                        : (e.target
                                            .value as ClashRule["severity_override"]),
                                  }
                                : x,
                            ),
                          )
