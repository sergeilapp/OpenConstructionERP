...
const CATEGORIES = [
  {
    value: "concrete",
    key: "assemblies.cat_concrete",
    defaultLabel: "Concrete",
  },
  ...
  {
    value: "earthwork",
    key: "assemblies.cat_earthwork",
    defaultLabel: "Earthwork",
  },
...
const UNITS = [
  ...
  {
    value: "m2",
    key: "units.square_meter",
    defaultLabel: "m\u00B2 -- Square meter",
  },
  {
    value: "m3",
    key: "units.cubic_meter",
    defaultLabel: "m\u00B3 -- Cubic meter",
  },
  ...
  {
    value: "lm",
    key: "units.linear_meter",
    defaultLabel: "lm -- Linear meter",
  },
];
...
const STANDARDS = [
  ...
  {
    value: "masterformat",
    key: "assemblies.std_masterformat",
    defaultLabel: "MasterFormat",
  },
  {
    value: "uniformat",
    key: "assemblies.std_uniformat",
    defaultLabel: "UniFormat",
  },
  {
    value: "uniclass",
    key: "assemblies.std_uniclass",
    defaultLabel: "Uniclass",
  },
];
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-semibold text-content-primary">
                {t("assemblies.new_assembly", {
                  defaultValue: "New Assembly‌⁠‍",
                })}
              </h2>
              <p className="text-xs text-content-tertiary">
                {t("assemblies.create_subtitle", {
                  defaultValue: "Create a reusable cost assembly‌⁠‍",
                })}
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-4">
              <Input
                ...
                placeholder={t("assemblies.code_placeholder", {
                  defaultValue: "e.g. ASM-001‌⁠‍",
                })}
                required
                autoFocus
              />
              <div className="col-span-2">
                <Input
                  ...
                  placeholder={t("assemblies.name_placeholder", {
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-sm font-medium text-content-primary">
                  {t("assemblies.category", { defaultValue: "Category" })}
                </label>
                <select
                  value={form.category}
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                <label className="text-sm font-medium text-content-primary">
                  {t("assemblies.classification_standard", {
                ...
                <select
                  ...
                  onChange={(e) =>
                    set("classificationStandard", e.target.value)
                  }
                  className={selectClass}
                >
                  <option value="">
                    {t("assemblies.none", { defaultValue: "-- None --" })}
                  </option>
                  {STANDARDS.map((s) => (
              ...
              <Input
                label={t("assemblies.classification_code", {
                  defaultValue: "Classification Code",
                })}
                value={form.classificationCode}
                onChange={(e) => set("classificationCode", e.target.value)}
                placeholder={t("assemblies.classification_code_placeholder", {
                  defaultValue: "e.g. 330",
                })}
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                <label className="text-sm font-medium text-content-primary">
                  {t("assemblies.currency", { defaultValue: "Currency" })}
                </label>
                <select
                  value={form.currency}
              ...
              <Input
                ...
                placeholder="1.00"
                hint={t("assemblies.bid_factor_hint", {
                  defaultValue:
                    "Multiplier applied to the total rate (1.00 = no markup)",
                })}
              />
            </div>
