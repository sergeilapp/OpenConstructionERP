  ...
  return (
    <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 py-6 items-center">
        ...
        <div className="text-center lg:text-left">
          ...
          <p className="mt-2 text-base text-content-secondary">
            {t("about.tagline", {
              defaultValue:
                "The #1 open-source platform for construction cost estimation, project management and resource control‌⁠‍",
            })}
          </p>
              ...
              {[
                {
                  v: "3.12.0",
                  date: "2026-05-20",
                  note: t("about.recent_3_12_0", {
                    defaultValue:
                      "Wave 5/6/7 pro-grade — BOQ + Cost Intel + Clash A4 + Files CDE",
                  }),
                },
                {
                  v: "3.11.0",
                  date: "2026-05-20",
                  note: t("about.recent_3_11_0", {
                    defaultValue:
                      "Wave 3/4 modules · Validation@Import · X84 export · /about redesign",
                  }),
                },
                {
                  v: "3.10.0",
                  date: "2026-05-19",
                  note: t("about.recent_3_10_0", {
                    defaultValue:
                      "/files ACC-grade wave · Clash collab/metadata · match polish",
                  }),
                },
              ].map((r) => (
                <li
                ...
                >
                  ...
                  <span className="shrink-0 font-mono text-content-quaternary">
                    {r.date}
                  </span>
                  <span
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
        ...
        <Card
          className="animate-card-in h-full flex flex-col"
          ...
          <div className="p-6 flex flex-col flex-1">
            ...
            <div className="grid grid-cols-3 sm:grid-cols-6 gap-2.5">
              {[
                {
                  value: "55K+",
                  label: t("about.stat_costs", {
                    defaultValue: "Cost Items (CWICR)‌⁠‍",
                  }),
                },
                {
                  value: "24",
                  label: t("about.stat_langs", {
                    defaultValue: "Languages‌⁠‍",
                  }),
                },
                {
                  value: "48",
                  label: t("about.stat_regions", {
                    defaultValue: "Regional Databases‌⁠‍",
                  }),
                },
                {
                  value: "6",
                  label: t("about.stat_cad_formats", {
                    defaultValue: "CAD/BIM formats supported",
                  }),
                },
                {
                  value: "100+",
                  label: t("about.stat_modules", {
                    defaultValue: "Backend modules‌⁠‍",
                  }),
                },
                {
                  value: "12",
                  label: t("about.stat_sections", {
                ...
                <div
                  key={i}
                  className="text-center rounded-xl bg-surface-secondary/50 px-2 py-3"
                >
                  <div className="text-xl font-bold text-content-primary leading-none">
                    {s.value}
                  </div>
                  <div className="text-2xs text-content-tertiary mt-1.5 leading-snug">
                    {s.label}
                  </div>
                </div>
              ))}
            ...
            <p className="mt-auto pt-4 text-sm text-content-secondary leading-relaxed">
              {t("about.platform_desc", {
                defaultValue:
                  "OpenConstructionERP covers the full construction estimation workflow — BOQ editing, 4D scheduling, 5D cost modeling, AI-powered estimation, CAD/BIM quantity takeoff (RVT, IFC, DWG, DGN), tendering, and reporting. Supports regional classification standards and custom schemas.",
              })}
            </p>
          </div>
        </Card>
              ...
              <div className="min-w-0 flex-1">
                <h3 className="text-sm font-semibold text-content-primary">
                  {t("about.community_title", {
                    defaultValue:
                      "Join the community — your feedback shapes the roadmap",
                  })}
                </h3>
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-xs text-content-secondary mt-0.5 leading-snug">
                    {t("about.community_telegram_v2", {
                      defaultValue:
                        "Fastest replies from the maintainers — questions, ideas, bug reports, partnerships.",
                    })}
                  </p>
                </div>
                <ExternalLink
                  size={13}
                  className="text-content-quaternary group-hover:text-[#26A5E4] shrink-0"
                />
              </a>
              ...
              <div className="grid grid-cols-2 gap-2.5">
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-2xs text-content-tertiary mt-0.5 leading-snug">
                      {t("about.community_linkedin_short", {
                        defaultValue: "Articles + industry posts",
                      })}
                    </p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-2xs text-content-tertiary mt-0.5 leading-snug">
                      {t("about.community_x_short", {
                        defaultValue: "Release announcements",
                      })}
                    </p>
                  </div>
                </a>
        ...
        <div className="p-6 grid grid-cols-1 lg:grid-cols-5 gap-x-8 gap-y-6">
          ...
          <div className="lg:col-span-3">
            ...
            <p className="mb-5 text-sm text-content-secondary">
              {t("about.story_subtitle", {
                defaultValue:
                  "Why OpenConstructionERP exists and where it is heading.",
              })}
            </p>
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-xs text-oe-blue font-medium mt-0.5">
                      {t("about.founder_role", {
                        defaultValue:
                          "Consultant for Automation & Data in Construction",
                      })}
                    </p>
                  </div>
                </div>
          ...
          <aside className="lg:col-span-2 lg:border-l lg:border-border-light lg:pl-8 flex flex-col h-full">
            <div className="mb-5 flex items-center gap-2">
              ...
              <h3 className="text-sm font-semibold text-content-primary">
                {t("about.ddc_ecosystem_title", {
                  defaultValue: "DDC Ecosystem",
                })}
              </h3>
            </div>
            <p className="text-xs text-content-tertiary mb-6">
              {t("about.ddc_ecosystem_subtitle", {
                defaultValue:
                  "Projects mentioned above — every one is open-source or has a free tier.",
              })}
            </p>

            {/* ── Subsection 1: Flagship products ── */}
            <p className="mb-2 text-2xs font-semibold uppercase tracking-wider text-content-tertiary">
              {t("about.ddc_flagship_label", {
                defaultValue: "Flagship products · datadrivenconstruction.io",
              })}
            </p>
              ...
              {[
                {
                  ...
                  label: "DataDrivenConstruction",
                  desc: t("about.ddc_link_lab", {
                    defaultValue: "Lab homepage — research & consulting",
                  }),
                },
                {
                  href: "https://datadrivenconstruction.io/books/",
                  label: "DDC Guidebook",
                  desc: t("about.ddc_link_book", {
                    defaultValue: "Reference reading, free, 16 languages",
                  }),
                },
                {
                  href: "https://github.com/datadrivenconstruction/cad2data-Revit-IFC-DWG-DGN-pipeline-with-conversion-validation-qto",
                  label: "CAD-BIM Converter",
                  desc: t("about.ddc_link_cad", {
                    defaultValue: "Pipeline: Revit · IFC · DWG · DGN → data",
                  }),
                },
                {
                  href: "https://datadrivenconstruction.io/excel-plugin/",
                  label: "DDC Excel Plugin",
                  desc: t("about.ddc_link_excel", {
                    defaultValue:
                      "Spreadsheet bridge — pull live data into Excel",
                  }),
                },
              ].map((item) => (
                <li key={item.href}>
                  ...
                  >
                    ...
                    <ArrowRight
                      size={14}
                      className="mt-1 shrink-0 text-content-quaternary group-hover:text-oe-blue group-hover:translate-x-0.5 transition-all"
                    />
                  </a>
                </li>
              ))}
            ...
            <p className="mb-2 text-2xs font-semibold uppercase tracking-wider text-content-tertiary">
              {t("about.ddc_oss_label", {
                defaultValue: "Open source on GitHub · @datadrivenconstruction",
              })}
            </p>
            <ul className="mb-6 space-y-2.5">
              {[
                {
                  href: "https://github.com/datadrivenconstruction/cad2data-Revit-IFC-DWG-DGN-pipeline-with-conversion-validation-qto",
                  label: "cad2data Pipeline",
                  desc: t("about.ddc_gh_cad2data", {
                    defaultValue:
                      "Revit · IFC · DWG · DGN → structured quantities",
                  }),
                },
                {
                  href: "https://github.com/datadrivenconstruction/OpenConstructionEstimate-DDC-CWICR",
                  label: "OpenConstructionEstimate",
                  desc: t("about.ddc_gh_cwicr", {
                    defaultValue:
                      "55,000+ cost items · 24 languages · 48 regions",
                  }),
                },
                {
                  href: "https://github.com/datadrivenconstruction",
                  label: "DDC Skills for AI Agents",
                  desc: t("about.ddc_gh_skills", {
                    defaultValue: "Tool definitions & prompts for LLM agents",
                  }),
                },
              ].map((item) => (
                <li key={item.href}>
                  ...
                  >
                    <Github
                      size={14}
                      className="mt-0.5 shrink-0 text-content-tertiary group-hover:text-content-primary transition-colors"
                    />
                    <div className="min-w-0 flex-1">
                      <p className="text-xs font-semibold text-content-primary leading-tight group-hover:text-oe-blue transition-colors">
                        {item.label}
            ...
            <div className="mt-auto">
              <p className="mb-2 text-2xs font-semibold uppercase tracking-wider text-content-tertiary">
                {t("about.ddc_network_label", {
                  defaultValue: "Find us across the network",
                })}
              </p>
              <div className="flex flex-wrap items-center gap-2">
                {[
                  ...
                  >
                    <Icon
                      size={17}
                      className="text-content-tertiary group-hover:text-oe-blue transition-colors"
                    />
                  </a>
                ))}
              </div>
        ...
        <div className="p-6">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h2 className="text-lg font-semibold text-content-primary">
              {t("about.services_title", {
                defaultValue: "Consulting & Professional Services",
              })}
            </h2>
          </div>
          <p className="text-sm text-content-secondary leading-relaxed mb-5 max-w-3xl">
            {t("about.services_desc_v2", {
              defaultValue:
                "Need a custom build, a workshop, or an outside expert on data + cost workflows? Data Driven Construction delivers three engagement shapes — pick what fits and we scope from there.",
            })}
          </p>
            ...
            {[
              {
                num: "01",
                icon: Rocket,
                title: t("about.svc_build_title", {
                  defaultValue: "Custom Build",
                }),
                tagline: t("about.svc_build_tagline", {
                  defaultValue: "FROM 4 WEEKS",
                }),
                desc: t("about.svc_build_desc", {
                  defaultValue:
                    "Discovery → workshop → modules picked → built → deployed on your hardware. Source delivered.",
                }),
                bullets: [
                  t("about.svc_build_b1", {
                    defaultValue: "4–12 weeks engagement",
                  }),
                  t("about.svc_build_b2", {
                    defaultValue: "AGPL or commercial license",
                  }),
                  t("about.svc_build_b3", {
                    defaultValue: "30 days post-launch support",
                  }),
                ],
              },
              {
                num: "02",
                icon: Users,
                title: t("about.svc_workshop_title", {
                  defaultValue: "Workshops",
                }),
                tagline: t("about.svc_workshop_tagline", {
                  defaultValue: "1–3 DAYS · ON-SITE OR REMOTE",
                }),
                desc: t("about.svc_workshop_desc", {
                  defaultValue:
                    "Hands-on sessions: estimating, BIM-to-BOQ, AI takeoff, GAEB pipelines. Recorded for your team library.",
                }),
                bullets: [
                  t("about.svc_workshop_b1", {
                    defaultValue: "Up to 12 participants",
                  }),
                  t("about.svc_workshop_b2", {
                    defaultValue: "Tailored agenda + exercises",
                  }),
                  t("about.svc_workshop_b3", {
                    defaultValue: "Slides + recordings retained by client",
                  }),
                ],
              },
              {
                num: "03",
                icon: Briefcase,
                title: t("about.svc_consulting_title", {
                  defaultValue: "Consulting",
                }),
                tagline: t("about.svc_consulting_tagline", {
                  defaultValue: "BY THE DAY · OR RETAINER",
                }),
                desc: t("about.svc_consulting_desc", {
                  defaultValue:
                    "Standards mapping, cost-DB strategy, pipeline architecture, code review.",
                }),
                bullets: [
                  t("about.svc_consulting_b1", {
                    defaultValue: "Async review option",
                  }),
                  t("about.svc_consulting_b2", {
                    defaultValue: "Outcome document + recommendations",
                  }),
                  t("about.svc_consulting_b3", {
                    defaultValue: "Rollover into custom build",
                  }),
                ],
              },
            ].map((svc) => (
                ...
                <ul className="mt-auto space-y-1.5">
                  {svc.bullets.map((b, i) => (
                    ...
                    >
                      <ArrowRight
                        size={11}
                        className="mt-1 shrink-0 text-oe-blue"
                      />
                      <span>{b}</span>
                    </li>
                  ))}
          ...
          <div className="mt-6 pt-5 border-t border-border-light">
            <p className="mb-3 text-2xs font-semibold uppercase tracking-wider text-content-tertiary">
              {t("about.svc_trusted_label", {
                defaultValue: "Selected engagements",
              })}
            </p>
            <div className="flex flex-wrap items-center gap-1.5">
              ...
              <span className="inline-flex items-center rounded-md border border-border-light bg-surface-secondary/40 px-2.5 py-1 text-xs text-content-tertiary italic">
                {t("about.svc_trusted_more", {
                  defaultValue: "+ engagements under NDA",
                })}
              </span>
            </div>
          </div>
          ...
          <div className="relative p-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
              <div className="flex items-center gap-2.5 mb-3">
                ...
                <h2 className="text-xl font-bold tracking-tight text-content-primary">
                  {t("about.support_title", {
                    defaultValue: "Support OpenConstructionERP",
                  })}
                </h2>
              </div>
              <p className="text-sm text-content-secondary leading-relaxed mb-5">
                {t("about.support_desc_short", {
                  defaultValue:
                    "Free, open-source, built by construction professionals. Every star, sponsor, or paid engagement keeps the project alive.",
                })}
              </p>
              ...
              <div className="space-y-2">
                ...
                >
                  <Star
                    size={22}
                    className="shrink-0 text-amber-500 group-hover:scale-110 group-hover:-rotate-6 transition-transform"
                    fill="currentColor"
                  />
                  <div className="min-w-0 flex-1">
                    <p className="text-sm font-bold text-content-primary leading-tight">
                      {t("about.support_star", {
                        defaultValue: "Star on GitHub",
                      })}
                    </p>
                    <p className="text-2xs text-content-tertiary leading-snug mt-0.5">
                      {t("about.support_star_desc", {
                        defaultValue:
                          "Show your support — it takes 2 seconds and helps others discover the project",
                      })}
                    </p>
                  </div>
                  <ArrowRight
                    size={14}
                    className="shrink-0 text-content-quaternary group-hover:text-amber-500 group-hover:translate-x-0.5 transition-all"
                  />
                </a>
                ...
                >
                  <Coffee
                    size={22}
                    className="shrink-0 text-rose-500 group-hover:scale-110 transition-transform"
                  />
                  <div className="min-w-0 flex-1">
                    <p className="text-sm font-bold text-content-primary leading-tight">
                      {t("about.support_sponsor", {
                        defaultValue: "Become a Sponsor",
                      })}
                    </p>
                    <p className="text-2xs text-content-tertiary leading-snug mt-0.5">
                      {t("about.support_sponsor_desc", {
                        defaultValue:
                          "Fund new features, regional databases, and keep the project free for everyone",
                      })}
                    </p>
                  </div>
                  <ArrowRight
                    size={14}
                    className="shrink-0 text-content-quaternary group-hover:text-rose-500 group-hover:translate-x-0.5 transition-all"
                  />
                </a>
                ...
                >
                  <Rocket
                    size={22}
                    className="shrink-0 text-oe-blue group-hover:scale-110 group-hover:-translate-y-0.5 transition-transform"
                  />
                  <div className="min-w-0 flex-1">
                    <p className="text-sm font-bold text-content-primary leading-tight">
                      {t("about.support_consulting", {
                        defaultValue: "Order Consulting",
                      })}
                    </p>
                    <p className="text-2xs text-content-tertiary leading-snug mt-0.5">
                      {t("about.support_consulting_desc", {
                        defaultValue:
                          "Need custom features, deployment, or training? We deliver professional solutions worldwide",
                      })}
                    </p>
                  </div>
                  <ArrowRight
                    size={14}
                    className="shrink-0 text-content-quaternary group-hover:text-oe-blue group-hover:translate-x-0.5 transition-all"
                  />
                </a>
              </div>
            </div>
            ...
            <div className="lg:border-l lg:border-border-light/60 dark:lg:border-white/[0.08] lg:pl-6 flex flex-col">
              <p className="text-xs font-semibold uppercase tracking-wider text-content-tertiary mb-3 flex items-center gap-1.5">
                ...
                {t("about.support_impact_label", {
                  defaultValue: "Impact so far",
                })}
              </p>
              <div className="grid grid-cols-2 gap-2.5 mb-4">
                {[
                  {
                    value: "24",
                    label: t("about.support_kpi_langs", {
                      defaultValue: "Languages translated",
                    }),
                  },
                  {
                    value: "48",
                    label: t("about.support_kpi_regions", {
                      defaultValue: "Regional cost packs",
                    }),
                  },
                  {
                    value: "100+",
                    label: t("about.support_kpi_modules", {
                      defaultValue: "Backend modules",
                    }),
                  },
                  {
                    value: "55K+",
                    label: t("about.support_kpi_cwicr", {
                      defaultValue: "CWICR positions",
                    }),
                  },
                ].map((kpi, i) => (
                  <div
                    key={i}
                    className="rounded-lg bg-surface-primary/60 backdrop-blur-sm border border-border-light px-3 py-2.5"
                  >
                    <div className="text-lg font-bold text-content-primary leading-tight">
                      {kpi.value}
                    </div>
                    <div className="text-2xs text-content-tertiary mt-0.5 leading-snug">
                      {kpi.label}
                    </div>
                  </div>
                ))}
              ...
              <p className="text-xs font-semibold uppercase tracking-wider text-content-tertiary mb-3 flex items-center gap-1.5">
                ...
                {t("about.support_enables", {
                  defaultValue: "Your support enables:",
                })}
              </p>
              <ul className="space-y-1.5">
                {[
                  t("about.support_e1", {
                    defaultValue: "New regional cost databases (CWICR)",
                  }),
                  t("about.support_e2", {
                    defaultValue: "AI estimation improvements",
                  }),
                  t("about.support_e3", {
                    defaultValue: "More CAD/BIM format support",
                  }),
                  t("about.support_e4", {
                    defaultValue: "Better PDF takeoff tools",
                  }),
                  t("about.support_e5", {
                    defaultValue: "Mobile app development",
                  }),
                  t("about.support_e6", {
                    defaultValue: "Free workshops and documentation",
                  }),
                ].map((item, i) => (
                  <li
                    key={i}
        ...
        <div className="p-6 grid grid-cols-1 lg:grid-cols-5 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-3 flex-wrap">
              ...
              <h2 className="text-lg font-semibold text-content-primary">
                {t("about.book_title", {
                  defaultValue: "Data-Driven Construction",
                })}
              </h2>
              <Badge variant="blue" size="sm">
                Free
            ...
            <p className="text-xs text-content-tertiary mb-4">
              {t("about.book_subtitle", {
                defaultValue:
                  "By Artem Boiko · 16 languages · 600+ pages · 10 parts, 173 chapters",
              })}
            </p>
            <a
              href="https://datadrivenconstruction.io/books/"
              ...
              title={t("about.book_cta", {
                defaultValue: "Pick your language on datadrivenconstruction.io",
              })}
            >
              <img
                src="/brand/ddc-book.png"
                alt={t("about.book_title", {
                  defaultValue: "Data-Driven Construction",
                })}
          ...
          <div className="lg:col-span-3">
            <p className="text-2xs font-semibold uppercase tracking-wider text-content-tertiary mb-3">
              {t("about.book_toc_label", {
                defaultValue: "Inside the book — 10 parts",
              })}
            </p>
            <ol className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              {[
                {
                  num: "I",
                  title: t("about.book_p1", {
                    defaultValue: "How information has evolved in construction",
                  }),
                },
                {
                  num: "II",
                  title: t("about.book_p2", {
                    defaultValue:
                ...
                {
                  num: "III",
                  title: t("about.book_p3", {
                    defaultValue:
                      "Data framework in construction business processes",
                  }),
                },
                {
                  num: "IV",
                  title: t("about.book_p4", {
                    defaultValue:
                      "Data quality: organization, structuring, modeling",
                  }),
                },
                {
                  num: "V",
                  title: t("about.book_p5", {
                    defaultValue:
                      "Cost & time calculations: incorporating data into processes",
                  }),
                },
                {
                  num: "VI",
                  title: t("about.book_p6", {
                    defaultValue:
                      "CAD & BIM — marketing, reality and the future of design data",
                  }),
                },
                {
                  num: "VII",
                  title: t("about.book_p7", {
                    defaultValue:
                      "Data-driven decision-making, analytics and automation",
                  }),
                },
                {
                  num: "VIII",
                  title: t("about.book_p8", {
                    defaultValue: "Data storage and management in construction",
                  }),
                },
                {
                  num: "IX",
                  title: t("about.book_p9", {
                    defaultValue: "Big Data, machine learning and forecasts",
                  }),
                },
                {
                  num: "X",
                  title: t("about.book_p10", {
                    defaultValue:
                      "The construction industry in the digital age — opportunities & challenges",
                  }),
                },
              ].map((p) => (
                <li
                  key={p.num}
                  className="group flex items-start gap-2.5 rounded-lg border border-border-light bg-surface-secondary/30 px-3 py-2.5 hover:border-oe-blue/30 hover:bg-oe-blue/[0.025] transition-colors"
                >
            ...
            <p className="mt-3 text-2xs text-content-tertiary italic">
              {t("about.book_toc_note", {
                defaultValue:
                  "173 chapters total. Free to read online or download.",
              })}
            </p>
          </div>
          {/* /Right column */}
          ...
          <div className="p-6 flex flex-col flex-1">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-content-tertiary">
                  {t("about.docs_desc", {
                    defaultValue:
                      "Installation guides, feature overview, API reference, and tutorials",
                  })}
                </p>
              </div>
            </div>
            <ul className="space-y-1.5 text-xs text-content-secondary mb-4">
              {[
                t("about.docs_b1", {
                  defaultValue:
                    "Installation & deployment guides (Docker, VPS, Kubernetes)",
                }),
                t("about.docs_b2", {
                  defaultValue:
                    "Feature walkthroughs — BOQ editor, BIM viewer, takeoff",
                }),
                t("about.docs_b3", {
                  defaultValue:
                    "OpenAPI reference for all 100+ backend modules",
                }),
                t("about.docs_b4", {
                  defaultValue: "Module SDK — write your own plugin",
                }),
              ].map((b, i) => (
            ...
            <p className="mb-2 text-2xs font-semibold uppercase tracking-wider text-content-tertiary">
              {t("about.docs_popular_label", {
                defaultValue: "Popular topics",
              })}
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {[
                {
                  href: "https://openconstructionerp.com/docs.html#quickstart",
                  label: t("about.docs_pop_quickstart", {
                    defaultValue: "Quick start — Docker compose",
                  }),
                },
                {
                  href: "https://openconstructionerp.com/docs.html#bim-import",
                  label: t("about.docs_pop_bim", {
                    defaultValue: "Import BIM (RVT/IFC) → BOQ",
                  }),
                },
                {
                  href: "https://openconstructionerp.com/docs.html#gaeb",
                  label: t("about.docs_pop_gaeb", {
                    defaultValue: "GAEB X83/X84 import & export",
                  }),
                },
                {
                  href: "https://openconstructionerp.com/docs.html#takeoff",
                  label: t("about.docs_pop_takeoff", {
                    defaultValue: "PDF takeoff with annotations",
                  }),
                },
                {
                  href: "https://openconstructionerp.com/docs.html#module-sdk",
                  label: t("about.docs_pop_sdk", {
                    defaultValue: "Module SDK · write a plugin",
                  }),
                },
                {
                  href: "https://openconstructionerp.com/docs.html#deploy",
                  label: t("about.docs_pop_deploy", {
                    defaultValue: "VPS deployment guide",
                  }),
                },
              ].map((topic) => (
                <a
          ...
          <div className="p-6 flex flex-col flex-1">
              ...
              <div className="flex-1 min-w-0">
                <h2 className="text-lg font-semibold text-content-primary">
                  {t("about.license_title", {
                    defaultValue: "License & Open Source",
                  })}
                </h2>
                <p className="text-xs text-content-tertiary">
                  {t("about.license_subtitle", {
                    defaultValue:
                      "AGPL-3.0 — free for any use, including commercial",
                  })}
                </p>
              </div>
            </div>
            <p className="text-sm text-content-secondary leading-relaxed mb-4">
              {t("about.license_desc_short", {
                defaultValue:
                  "GNU Affero General Public License v3.0 — copyleft. The full text ships with the source and is also available at gnu.org/licenses/agpl-3.0.",
              })}
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-3 mb-4">
              <div>
                ...
                <ul className="space-y-1 text-xs text-content-secondary leading-snug">
                  {[
                    t("about.license_youcan_1", {
                      defaultValue: "Use for any purpose, including commercial",
                    }),
                    t("about.license_youcan_2", {
                      defaultValue: "Self-host on your own hardware",
                    }),
                    t("about.license_youcan_3", {
                      defaultValue: "Modify, fork, and redistribute",
                    }),
                    t("about.license_youcan_4", {
                      defaultValue: "Build proprietary modules on top",
                    }),
                  ].map((b, i) => (
              ...
              <div>
                <p className="mb-1.5 text-2xs font-semibold uppercase tracking-wider text-amber-600 dark:text-amber-400">
                  {t("about.license_youmust_label", {
                    defaultValue: "You must",
                  })}
                </p>
                <ul className="space-y-1 text-xs text-content-secondary leading-snug">
                  {[
                    t("about.license_youmust_1", {
                      defaultValue: "Share modifications under AGPL-3.0",
                    }),
                    t("about.license_youmust_2", {
                      defaultValue: "Provide source to network users",
                    }),
                    t("about.license_youmust_3", {
                      defaultValue: "Keep copyright + license notices",
                    }),
                    t("about.license_youmust_4", {
                      defaultValue: "Document what you changed",
                    }),
                  ].map((b, i) => (
                    <li key={i} className="flex items-start gap-1.5">
            ...
            <div className="flex flex-wrap gap-1.5 mb-4">
              <Badge variant="success" size="sm">
                {t("about.license_badge_free", { defaultValue: "Free to use" })}
              </Badge>
              <Badge variant="success" size="sm">
                {t("about.license_badge_oss", { defaultValue: "Open source" })}
              </Badge>
              <Badge variant="success" size="sm">
                {t("about.license_badge_selfhost", {
                  defaultValue: "Self-hosted",
                })}
              </Badge>
              <Badge variant="success" size="sm">
                {t("about.license_badge_nolockin", {
                  defaultValue: "No vendor lock-in",
                })}
              </Badge>
              <Badge variant="blue" size="sm">
                AGPL-3.0
            ...
            <div className="mt-auto pt-3 border-t border-border-light">
              <p className="text-xs text-content-secondary mb-2">
                {t("about.license_commercial_short", {
                  defaultValue:
                    "Need a commercial licence (without AGPL obligations) or an enterprise SLA?",
                })}
              </p>
              <a
                href="https://datadrivenconstruction.io/contact-support/"
              ...
              >
                <Button
                  ...
                  icon={<Shield size={15} />}
                >
                  {t("about.license_commercial_cta", {
                    defaultValue: "Commercial licensing",
                  })}
                </Button>
              </a>
            </div>
      ...
      <div className="text-center py-4 text-xs text-content-quaternary">
        ...
        <p className="mt-1">
          &copy; 2026 Data Driven Construction. All rights reserved.
        </p>
      </div>
    </div>
  );
